...
public class DateUtil {
    ...
    public static Timestamp lastMothFirstDateTime(){
        ...
        try {
            ...
            dateBuilder.append(cal.get(Calendar.YEAR)).append("-").append(cal.get(Calendar.MONTH) + 1).append("-01 00:00:00");
            lastMothFirstDateTime = DateUtil.getDateTimeFormatByString(dateBuilder.toString(), DateUtil.FORMAT_LONGDATETIME);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static Timestamp lastMotLastDateTime(){
        ...
        try {
            ...
            StringBuilder dateBuilder = new StringBuilder();
            dateBuilder.append(cal.get(Calendar.YEAR)).append("-").append(cal.get(Calendar.MONTH) + 1).append("-").append(cal.get(Calendar.DATE)).append(" 00:00:00");
            lastMothFirstDateTime = DateUtil.getDateTimeFormatByString(dateBuilder.toString(), DateUtil.FORMAT_LONGDATETIME);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getNowFunc() {
        ...
        try {
            if (DAOManager.getDataBaseType().equals("oracle")) {
                ...
                throw new Exception("not supported. currently only supports oracle/mysql");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    /**
     * 把字符串转换成日期，如:
     * oracle 写法：to_date('2008-06-07 17:02:23','yyyy-MM-DD HH24:MI:SS')
     * mysql 写法： timestamp('2008-06-07 17:02:23')
     *
     * @param date   日期字符串
     * @param format 日期格式
     * @return
	...
	/**
	 * <p>方法名称: dateTimeErrand|描述: 计算两个时间，返回差值</p>
	 * @param starttime
	 * @param endtime
	 * @return
	 ...
	 */
	public static String dateTimeErrand(String starttime,String endtime) throws ParseException{

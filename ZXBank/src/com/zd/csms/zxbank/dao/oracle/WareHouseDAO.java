...
public class WareHouseDAO extends DAOSupport implements IWareHouseDAO{
	...
	public boolean add(Warehouse ws) {
		String sql="insert into ZX_WAREHOUSE(zx_whid,zx_custno,ZX_LONCPNAME,zx_whname,zx_whcode,zx_whlevel,zx_whoperorg,zx_whaddress,zx_phone,zx_createdate,zx_updatedate) values(zx_warehouseId.nextval,?,?,?,?,?,?,?,?,to_date(?,'YYYY-MM-DD HH24:MI:SS'),to_date(?,'YYYY-MM-DD HH24:MI:SS'))";

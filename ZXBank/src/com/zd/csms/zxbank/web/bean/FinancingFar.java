 ...
 * 融资信息表
 */
public class FinancingFar implements Serializable{
...
//	private String lonentnm;//借款企业名称（是否需要）
	...
	public String toString() {
		return "Financing [loanstDate=" + loanstDate + ", loanendDate="
				+ loanendDate + ", loanCode=" + loanCode + ", scftxNo="
				+ scftxNo + ", loanAmt=" + loanAmt + ", bailRat=" + bailRat
				+ ", slfcapRat=" + slfcapRat + ", fstblRat=" + fstblRat
				+ ", procrt=" + procrt + ", bizMod=" + bizMod + ", operOrg="
				+ operOrg + "]";
	}

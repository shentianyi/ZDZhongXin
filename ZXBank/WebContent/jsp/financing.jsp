	...
	<html:form action="Financing.do" styleId="fiForm" method="post" onsubmit="return false">
		...
		<div class="public-main-input ly-col-1 abs" >
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    <div class="ly-col fl">
                        <div class="label block fl hidden"><font class="req" color="#FF0000" style="visibility:hidden;">*</font>借款企业ID：</div>
	                    <div class="input block fl hidden">
	                    	<%-- <html:text property="financingVO.fgLonentNo" styleId="fgLonentNo"/> --%>
	                    	<input class="ly-bor-none" id="fgLonentNo" name="financingVO.fgLonentNo" type="text"/>
	                    </div>
                    </div>
                    <div class="ly-col fl">
                        <div class="label block fl hidden"><font class="req" color="#FF0000" style="visibility:hidden;">*</font>融资起始日-开始：</div>
	                    <div class="input block fl hidden">
                    ...
                    <div class="ly-col fl">
	                    ...
	                    <div class="input block fl hidden">
	                    	<select class="ly-bor-none" id="choose" onchange="doChoose(this.value)">
					...
					<tbody class="t-tbody hidden">
						<logic:iterate name="list" id="row" indexId="index">
							<tr class="t-tr">
								...
								<td class="t-td">
									<c:if test="${row.fgProcrt==1}">
										银行承兑汇票
									</c:if>
								<td class="t-td"><c:out value="${row.fgOperOrg}"/></td>
								<td class="t-td">
									<c:if test="${row.fgBizMod==11}">
										汽车金融先票后货三方
									</c:if>
								</td>
								<td class="t-td">
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="Financing" action="Financing.do?method=financing" />
			</div>
		</div>
		</html:form>
	</div>

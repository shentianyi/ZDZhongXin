	...
	<div class="ly-contai rel">
		...
		<div class="public-main-input ly-col-3 hidden abs">
				...
				<div class="ly-button-w">
	                <a href="removepledge.do?method=removepledge" class="button btn-query">返回</a>
           	    </div>
			</div>
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="RemovePledgeDetail" action="removepledgedetail.do?method=removepledgedetail&rdno=${rp.rpNo}" />
			</div>
		</div>
		</html:form>
	</div>

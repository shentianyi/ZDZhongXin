...
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/removepledge.do" styleId="rpForm" method="post" onsubmit="return false">
			...
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl">
	                    ...
	                    <div class="input block fl hidden">
	                    	<input class="ly-bor-none" id="rpLoncpname" type="text" name="removepledge.rpLoncpname" value=""/>
	                    </div>
                    </div>
				</div>
			</div>
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="RemovePledge" action="removepledge.do?method=removepledge" />
			</div>
		</div>
		</html:form>
	</div>

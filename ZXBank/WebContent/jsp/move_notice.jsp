		...
		<div class="ly-contai clearfix">
			<div class="public-bar-crumbs fl hidden">
				<a class="crumbs-link" href="/ZXBank">中信银行接口</a> > <a
					class="crumbs-link" href="#">移库通知</a>
			</div>
		</div>
	</div>
	<div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/movenotice.do" styleId="mnForm" method="post"
						...
						<div class="ly-row clearfix">
							<div class="ly-col fl">
								...
								<div class="input block fl hidden">
									<input class="ly-bor-none" id="mnNo" type="text"
										name="movenotice.mnNo" value="" />
								</div>
							</div>
							<div class="ly-col fl">
								<div class="label block fl hidden">借款企业名称：</div>
								<div class="input block fl hidden">
									<input class="ly-bor-none" id="mnLoncpname" type="text"
										name="movenotice.mnLoncpname" value="" />
								</div>
							</div>
						</div>
					</div>
									...
									<c:if test="${not empty list }">
										<logic:iterate name="list" id="row" indexId="index">
											<tr class="t-tr">
												...
												<td class="t-td"><c:out value="${row.mnCreatedate}" /></td>
												<td class="t-td"><c:out value="${row.mnUpdatedate}" /></td>
												<td class="t-td"><a
													href="movedetail.do?method=movedetail&mdno=<c:out value='${row.mnNo }'/>">详情</a>
												</td>
											</tr>
										</logic:iterate>
									</c:if>
				...
				<div class="public-main-footer hidden abs">
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools
							...
							tableName="MoveNotice" action="movenotice.do?method=movenotice" />
					</div>
				</div>
			</html:form>
		</div>

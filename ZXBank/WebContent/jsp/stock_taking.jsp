				...
				<div class="ly-input-w">
					<div class="ly-row clearfix">
						<div class="ly-col fl">
							...
							<div class="input block fl hidden">
								<input class="ly-bor-none" type="text" id="" name="" value="" />
							</div>
						</div>

						<div class="ly-col fl">
							<div class="label block fl hidden">
								<font color="#FF0000">*</font>监管协议编号：
							</div>
							<div class="input block fl hidden">
								<input class="ly-bor-none" type="text" id="" name="" value="" />
							</div>
					...
					<div class="ly-row clearfix">
						...
						<div class="ly-col fl">
							...
							<div class="input block fl hidden">
								<input type="text" id="date1" name="" value="" />
							</div>
						</div>
						<div class="ly-col fl">
							<div class="label block fl hidden">
							...
							<div class="input block fl hidden">
								<input type="text" id="date2" name="" value="" />
							</div>
						</div>
					</div>
					<div class="ly-row clearfix">
						...
						<div class="ly-col fl">
							...
							<div class="input block fl hidden">
								<input style="padding: 3px 0 3px 0; margin-left: 10%; margin-top: 5px;" id="importFile" type="file"
									name="importFile" accept=".xls" />
							</div>
						</div>
						<div class="ly-col fl">

document.write("<div id='meizzCalendarLayer' name='meizzCalendarLayer' style='display: none'>");
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#fdc04d";    //控件的暗色 8DBDFE    
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#C9DDFE";    //控件的按钮背景色 C9DDFE
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#B4B4B4";    //控件的暗文字颜色 DCDCDC
    this.dayBgColor = "#ffeece";    //日期数字背景色  
...
function getObjectById(id){ if(document.all) return(eval("document.all."+ id)); return(document.getElementById(id)); }
...
{
  WebCalendar.objExport.innerHTML?WebCalendar.objExport.innerHTML='请选择公司成立日期':WebCalendar.objExport.value = '请选择公司成立日期';
  hiddenCalendar();
}

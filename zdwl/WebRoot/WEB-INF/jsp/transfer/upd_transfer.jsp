...
<input type="hidden" name="method" id="method" value="updTransfer"/>
<html:hidden property="transfer.id" styleId="transfer.id" />
<html:hidden property="transfer.dealerId" styleId="transfer.dealerId" />
<html:hidden property="transfer.createUser" styleId="transfer.createUser" />
<html:hidden property="transfer.createTime" styleId="transfer.createTime" />
<html:hidden property="transfer.lastModifyUser" styleId="transfer.lastModifyUser" />
<html:hidden property="transfer.lastModifyTime" styleId="transfer.lastModifyTime" />
<table class="formTable">
	<tr class="formTitle">
		<td colspan="4">修改调动表记录</td>
	</tr>
	<tr>
		<td colspan="4"> 
			<table >
				<tr>
					...
					<td class="codeCol">
						<form:select property="transfer.dealerId" disabled="true"
				...
				<tr>
					...
					<td class="nameCol"><font color="#FF0000">*</font>密保：</td>
					<td class="codeCol">

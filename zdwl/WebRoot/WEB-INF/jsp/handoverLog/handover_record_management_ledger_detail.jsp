...
//执行返回列表操作
function doReturn(){
    location = "<url:context/>/handoverLog.do?method=HandoverRecordManagementLedgerList";
}
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">交接记录管理详情</a>
         </span>
</div>
...
<table class="formTable">
        ...
        <td colspan="4"> 
            <table >
                ...
                <tr>
                    ...
                    <td class="nameCol"style="text-align: left;width: 300px" >
    ...
    <tr>
        <td class="nameCol" colspan="4" style="text-align: left;">4、私自售卖车辆</td>
    </tr>
    <tr>
        <td colspan="4">
        <div class="dvScroll">
    ...
    <tr>
        <td class="nameCol" colspan="4" style="text-align: left;">5、私自移动车辆</td>
    </tr>
    <tr>
    <td colspan="4">
        <div class="dvScroll">
    ...
    <tr>
        <td colspan="4">
            <table style="width:100%;">
                ...
                <tr>
                    <td class="codeCol" colspan="3">开机密码：<form:radios  property="officeEquipment.computerOnPassword" disabled="true" collection="informorno" styleId="officeEquipment.computerOnPassword" />
                ...
                <tr>
                    <td class="codeCol" colspan="3">密码：<form:radios  disabled="true" property="officeEquipment.safetyBoxPasswordStatus" collection="informorno" styleId="officeEquipment.safetyBoxPasswordStatus" />
...
<div id="pd_<c:out value='${picId1}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath1}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId2}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath2}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId3}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath3}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId4}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath4}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId5}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath5}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId6}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath6}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId7}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath7}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId8}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath8}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId9}'/>" style="display: none" class="dlDiv"> 
    <img alt="" src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath9}'/>" height="960" width="1280"/>
</div> 
...
<div id="pd_<c:out value='${picId10}'/>" style="display: none" class="dlDiv"> 
    <img alt="" 
    src="/showImg.do?method=showImg&filePath=<c:out value='${fixedpath10}'/>" height="960" width="1280"/>
</div> 
<div id="overDiv_<c:out value='${picId10}'/>" style="display:none;" class="overDiv" onclick="closeDiv('<c:out value='${picId10}'/>')">

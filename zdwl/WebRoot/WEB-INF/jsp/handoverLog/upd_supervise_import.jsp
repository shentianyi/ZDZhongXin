...
<div class="title">
	<c:choose>  
	   <c:when test="${superviseImportStatus==5}">修改私自售卖车辆</c:when>  
	   <c:when test="${superviseImportStatus==6}">修改私自移动车辆</c:when>    
	</c:choose> 
</div>
...
<table class="formTable">
	...
	<tr>
		...
		<td class="nameCol"><font color="#FF0000">*</font>车架号：</td>
		<td class="codeCol">
	...
	<tr>
		...
		<td class="codeCol">
			<input type="text" name="superviseImport.money" id="superviseImport.money" 
								...
								data-options="min:0,precision:2" value='<c:out value="${handoverLogForm.superviseImport.money}"/>'></input>
		</td>

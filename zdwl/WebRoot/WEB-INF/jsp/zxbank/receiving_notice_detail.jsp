		...
		<div class="ly-contai clearfix">
			<div class="public-bar-crumbs fl hidden">
				<a class="crumbs-link" href="#">中信银行接口</a> &gt; <a
					class="crumbs-link" href="#">收货通知</a> &gt; <a class="crumbs-link"
					href="#">通知详细查询</a>
			</div>
		</div>
	</div>
			...
			<html:form action="/ZXinterface.do" method="post"
				...
				<div class="public-main-input ly-col-4 abs">
					<div class="ly-input-w">
						...
						<div class="ly-row clearfix">
							...
							<div class="ly-col fl">
								...
								<div class="input block fl hidden">
									<select:timestamp timestamp="${receiving.nyCsndate}"
										idtype="ss" />
								</div>
							</div>
						</div>
						<div class="ly-row clearfix">
							...
							<div class="ly-col fl">
								...
								<div class="input block fl hidden">
									<select:timestamp timestamp="${receiving.nyNtcdate}"
										idtype="ss" />
								</div>
							</div>
						</div>
					...
					<div class="ly-button-w">
						<a href="javascript:saveCode();" class="button btn-query">导出</a> <a
							href="javascript:history.go(-1);" class="button btn-query">返回</a>
					</div>
				</div>

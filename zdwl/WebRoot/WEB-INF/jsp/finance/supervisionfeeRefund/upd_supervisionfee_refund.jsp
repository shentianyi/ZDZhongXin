...
function doSave(){
	...
	var value = document.getElementById("supervisionfee.refund_time").value;
	if(value == ""){
		alert("请填写退费时间");
		return false;
	}
	var value = document.getElementById("supervisionfee.refund_money").value;
	if(value == ""){
		alert("请填写退费金额");
		return false;
	}
	var value = document.getElementById("supervisionfee.refund_des").value;
	if(value == ""){
		alert("请填写退费原因");
		return false;
	}
...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/supervisionfeeRefund.do?method=supervisionfeeRefundList";
}
...
<body onLoad="doLoad()">
<div class="title">修改监管费/仓储费缴费</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/supervisionfeeRefund" styleId="supervisionfeeForm" method="post" onsubmit="return false">
<html:hidden property="supervisionfee.id" styleId="supervisionfee.id"/>
<input type="hidden" name="supervisionfee.type" id="supervisionfee.type" value="2">
<input type="hidden" name="method" id="method" value="updSupervisionfeeRefund">
...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol">
			<form:calendar property="supervisionfee.intime" styleId="supervisionfee.intime" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
		</td>
	...
	<tr>
		...
		<td class="codeCol">
			<form:calendar property="supervisionfee.pay_time" styleId="supervisionfee.pay_time" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
		</td>
	...
	<tr>
		...
		<td class="codeCol">
			<form:calendar property="supervisionfee.refund_time" styleId="supervisionfee.refund_time" pattern="<%=PatternConstants.TIMESTAMP_SS.getCode()%>" readonly="true" />
		</td>
		<td class="nameCol"><font color="#FF0000">*</font>退费金额：</td>
		<td class="codeCol">
			<html:text property="supervisionfee.refund_money" styleId="supervisionfee.refund_money"></html:text>
		</td>
	</tr>
	<tr>
		<td class="nameCol"><font color="#FF0000">*</font>退费原因：</td>
		<td class="codeCol">
			<html:text property="supervisionfee.refund_des" styleId="supervisionfee.refund_des"></html:text>
		</td>
		<td class="nameCol">备注</td>
		<td class="codeCol">
			<html:text property="supervisionfee.des" styleId="supervisionfee.des"></html:text>
		</td>
	</tr>

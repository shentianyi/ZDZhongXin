...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/ledger/mailcost.do?method=mailcostLedger";
}
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/ledger/mailcost" styleId="mailcostForm" method="post" onsubmit="return false">
				...
				<input type="hidden" name="method" id="method" value="mailcostDetail">
				<table class="formTable">
					<tr>
						...
						<td class="codeCol">
							<form:checkboxs property="mailingitemss" styleId="mailingitemss" collection="mailcostStateOptions"/>
						</td>
					</tr>
					<tr>
						<td class="nameCol">配件：</td>
						<td class="codeCol">
							<html:text property="mailcost.parts" styleId="mailcost.parts" readonly="true"></html:text>
						</td>
						<td class="nameCol">其它：</td>
						<td class="codeCol">
							<html:text property="mailcost.other" styleId="mailcost.other" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol">邮寄人：</td>
						<td class="codeCol">
							<form:select property="mailcost.mailperson" styleId="mailperson" onchange="changeYj(this.value)">
					...
					<tr>
						...
						<td class="codeCol">
							<html:text property="mailcost.express" styleId="mailcost.express" readonly="true"></html:text>
						</td>
						<td class="nameCol">预计金额：</td>
						<td class="codeCol">
							<html:text property="mailcost.money" styleId="mailcost.money" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol">运输城市起：</td>
						<td class="codeCol">
							<html:text property="mailcost.transportbegin" styleId="mailcost.transportbegin" readonly="true"></html:text>
						</td>
						<td class="nameCol">运输城市止：</td>
						<td class="codeCol">
							<html:text property="mailcost.transportend" styleId="mailcost.transportend" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol">接收人：</td>
						<td class="codeCol">
							<form:select property="mailcost.receiveid" styleId="receiveid" onchange="changeJs(this.value)">
								<html:option value="-1">请选择</html:option>
								<html:optionsCollection name="superviseOptions" label="label" value="value" />
							</form:select>
						</td>
					...
					<tr>
						...
						<td class="codeCol">
							<html:text property="mailcost.des" styleId="mailcost.des" readonly="true"></html:text>
						</td>
						<td class="nameCol"></td>
						<td class="codeCol"></td>
					</tr>

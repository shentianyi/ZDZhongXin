...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/ledger/resignApply.do?method=findPageList";
}
function showDiv(){
...
<html:form action="/ledger/resignApply" styleId="resignApplyForm" method="post" onsubmit="return false" enctype="multipart/form-data">

...
function init(){
	...
	function detail(id){
		location.href="<url:context/>/ledger/checkStockManage.do?method=detailPage&checkStock.id="+id;
	}
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<html:form action="/ledger/checkStockManage.do" styleId="checkStockManageForm" method="post" onsubmit="return false">
					...
					<div class="ly-row clearfix">
	                    ...
	                    <div class="ly-col fl">
	                       <div class="label block fl hidden ">查库方式：</div>
	                        <div class=" add_easyui input block fl hidden ">
	                        	<select style="width:80%;margin-top:10px;margin-left:6px;"class="ly-bor-none" name="query.checkStockType" >
									<option value="-1">请选择</option>
			...
			<div class="public-main-footer hidden abs">
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="list" action="/ledger/checkStockManage.do?method=findList" />
				</div>
			</div>
		</html:form>
	</div>

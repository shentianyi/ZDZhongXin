...
function goDetail(id){
	...
	location = "<url:context/>/ledger/fixedAssetList.do?method=detailFixedAssetList&fixedAssetList.id="+id+"&fid="+fid;
}
...
function doreturn(){
	location="<url:context/>/ledger/fixedAssets.do?method=fixedAssetsLedger";
}
/* 完成需求32 easyUI下拉筛选控件 */
$(function(){
	...
	<div class="ly-contai rel">
                    ...
                    <div class="ly-col fl">
                        ...
                        <div class="input block fl hidden">
                        	<div class="ly-sel-w">
								...
								<select id="fixedAssetListquery.username" style="width:100px;" name="fixedAssetListquery.username" >
					...
					<tbody class="t-tbody hidden">
						<logic:iterate name="list" id="row" indexId="index">
							<tr class="t-tr">
								...
								<td class="t-td"><c:out value="${row.trade_province}"/></td>
								<td class="t-td"><c:out value="${row.address}"/></td>
								<td class="t-td"><c:out value="${row.trade_city}"/></td>
		...
		<div class="public-main-footer hidden abs">
			...
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="fixedAssetList" action="/ledger/fixedAssetList.do?method=fixedAssetList"/>
			</div>
		</div>
		</html:form>
	</div>

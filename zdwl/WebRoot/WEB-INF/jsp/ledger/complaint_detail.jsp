...
<script>
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/ledger/complaint.do?method=complaintLedger";
	}
...
<body onLoad="doLoad()">
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/ledger/complaint.do" styleId="complaintForm"
				...
				<table class="formTable" style="margin-top:-20px;">
					<tr>
						<td class="add_textStyle"><font color="#FF0000">*</font>日期：</td>
						
						<td class="add_textRight">
						...
						<td class="add_textStyle"><font color="#FF0000">*</font>时间：</td>
						<td class="add_textRight">
					...
					<tr>
						<td class="add_textStyle"><font color="#FF0000">*</font>记录人：</td>
						<td class="add_textRight"><html:text style="width:100%;height:30px;border:1px solid #DDDDDD" property="complaint.createUserName" styleId="complaint.createUserName" readonly="true"></html:text></td>
						<td class="nameCol"><font color="#FF0000">*</font>所属部门：</td>
						<td class="codeCol"><html:text property="complaint.createUserDept" styleId="complaint.createUserDept" readonly="true"></html:text></td>
					</tr>
					...
					<tr id="complaintObjInfoOne">
						...
						<td class="codeCol"><html:text property="complaint.brandId" styleId="brand" readonly="true"></html:text></td>
					</tr>
					
					<tr id="complaintObjInfoTwo">
						<td class="nameCol"><font color="#FF0000">*</font>来电人：</td>
						<td class="codeCol"><html:text property="complaint.complainantName" readonly="true" styleId="complaint.complainantName"></html:text></td>
						<td class="nameCol"><font color="#FF0000">*</font>职务：</td>
						<td class="codeCol"><html:text property="complaint.complainantPosition" readonly="true" styleId="complaint.complainantPosition"></html:text></td>
					</tr>
					...
					<tr>
						...
						<td class="codeCol" colspan="3"><html:textarea property="complaint.contentText" styleId="complaint.contentText" readonly="true" style="width:530px"></html:textarea></td>
					</tr>
					
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>处理意见：</td>
						<td class="codeCol" colspan="3"><html:textarea property="complaint.treatmentOpinion" styleId="complaint.treatmentOpinion" readonly="true" style="width:530px"></html:textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>解决方案：</td>
						<td class="codeCol" colspan="3"><html:textarea property="complaint.solution" styleId="complaint.solution" readonly="true" style="width:530px"></html:textarea></td>
					</tr>
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>解决方案经办人：</td>
						<td class="codeCol"><html:text property="complaint.solutionOperatorName" styleId="complaint.solutionOperatorName" readonly="true"></html:text></td>
						<td class="nameCol"><font color="#FF0000">*</font>解决方案填写时间：</td>
						<td class="codeCol">
					...
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>跟踪情况：</td>
						<td class="codeCol" colspan="3"><html:textarea property="complaint.trackCondition" styleId="complaint.trackCondition" style="width:530px" readonly="true"></html:textarea></td>
					</tr>
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>跟踪情况经办人：</td>
						<td class="codeCol"><html:text property="complaint.trackOperatorName" styleId="complaint.trackOperatorName" readonly="true"></html:text></td>
						<td class="nameCol"><font color="#FF0000">*</font>跟踪情况填写时间：</td>
						<td class="codeCol">

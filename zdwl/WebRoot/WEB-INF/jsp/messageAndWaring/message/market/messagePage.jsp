...
.oneBankId, .twoBankId, .threeBankId, .provinceId, .cityId, .countyId {
	margin: 3% 10%;
	width: 50%;
	height: 64%;
}
...
<script type="text/javascript" src="/pagejs/messageAndWaring/list.js"></script>
...
<body class="h-100 public" onLoad="doLoad()">
	<div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/remindAndWaring.do" styleId="remindAndWaringForm"
				method="post" onsubmit="return false">
				 <%@include file="./messageQuery.jsp"%> 
				...
				<div class="public-main-footer hidden abs">
					<a href="javascript:doMessageSubmit();" class="button btn-add fl">提交</a>
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools
							className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>"
							tableName="list" action="/remindAndWaring.do?method=findMessageList" />
					</div>
				</div>

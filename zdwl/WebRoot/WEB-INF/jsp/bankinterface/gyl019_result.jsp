...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#"> 在库押品信息查询</a>
         </span>
</div>
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<input name="method" id="method" type="hidden" value="gyl019" />
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<c:if test="${not empty list }">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="gyl019" action="/bank/interface.do?method=gyl019" />
				</c:if>
			</div>
		</div>
		</html:form>

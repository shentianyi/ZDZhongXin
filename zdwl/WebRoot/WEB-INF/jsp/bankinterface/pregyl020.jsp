...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">提货申请</a>
         </span>
</div>
		...
		<div class="public-main-input ly-col-2 hidden abs">
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl">
                        <div class="label block fl hidden"><font color="#FF0000">*</font>质押合同编号：</div>
	                    <div class="input block fl hidden">
                    ...
                    <div class="ly-col fl">
	                    ...
	                    <div class="input block fl hidden">
	                    	<a style="color: blue;" href="/system/importTemplate/tihuoshenqing.xls">下载</a>
	                    </div>
                    </div>
				</div>
			</div>
			<div class="ly-button-w">
                <a href="javascript:doQuery('pregyl020');" class="button btn-query">导入</a>
                <c:if test="${not empty list }">
                	<a href="javascript:doQuery('gyl020');" class="button btn-query">发送</a>
                </c:if>
            </div>
		</div>
						...
						<c:if test="${not empty list }">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td"><c:out value='${row.deliveryQuantity }'/></td>
								</tr>
							</logic:iterate>
						</c:if>
					</tbody>

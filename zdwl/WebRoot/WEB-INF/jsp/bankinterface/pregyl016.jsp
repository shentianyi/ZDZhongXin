...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">出质入库申请</a>
         </span>
</div>
		...
		<div class="public-main-input ly-col-2 hidden abs">
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl">
                        <div class="label block fl hidden"><font color="#FF0000">*</font>仓库地址：</div>
	                    <div class="input block fl hidden">
				...
				<div class="ly-row clearfix">
					<div class="ly-col fl">
	                    ...
	                    <div class="input block fl hidden">
	                    	<a style="color: blue;" href="/system/importTemplate/chuzhiruku.xls">下载</a>
	                    </div>
                    </div>
				</div>

...
function goDetail(id){
    location.href="<url:context/>/handoverPlan.do?method=HandoverPlanLedgerListDetail&handoverPlan.id="+id;
}
...
/* function goWaitApproval(){
    location.href="<url:context/>/handoverPlan.do?method=HandoverPlanLedgerList";
} */
//执行查询操作
function doQuery(){
    $("#method").val("HandoverPlanLedgerList");
...
//导出轮岗计划表台账
function goExport(){
    $("#method").val("ExtHandoverPlanLedgerList");
    document.forms[0].submit();
    $("#queryDeliverer").val("");
}
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#"> 轮岗计划表台账</a>
         </span>
</div>
...
<div class="public-main abs">
    <div class="ly-contai rel">
        <html:form action="/handoverPlan" styleId="handoverPlanForm" method="post" onsubmit="return false">
            <input name="method" id="method" type="hidden" value="HandoverPlanLedgerList"/>
                            ...
                            <div class="input block fl hidden">
                                <div class="ly-sel-w">
                                    <select style="width:80%" id="queryDeliverer" name="query.deliverer" >
                                        ...
                                        <c:forEach items="${allSupervisors }" var="row">
                                            <option <c:if test="${handoverPlanForm.query.deliverer==row.value}">selected='selected'</c:if> value="<c:out value='${row.value }'/>"><c:out value="${row.label }"/></option> 
                                        </c:forEach>
                                    </select>
                                </div>
            ...
            <div class="public-main-footer hidden abs">
                ...
                <div class="public-main-footer-pagin fr">
                    <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="HandoverPlanLedgerList" action="/handoverPlan.do?method=HandoverPlanLedgerList"/>
                </div>
            </div>
        </html:form>
    </div>

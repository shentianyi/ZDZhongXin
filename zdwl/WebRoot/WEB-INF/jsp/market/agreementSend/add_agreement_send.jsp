...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol">
			<form:select property="agreementSend.province" onchange="changeProvince(this.value,$('#city'))" 
				styleId="province" >
				<html:option value="-1">请选择</html:option>
			</form:select>
		</td>
	...
	<tr>
		...
		<td class="codeCol">
			<form:select property="agreementSend.city" onchange="changeProvince(this.value,$('#county'))"
				styleId="city" >
				<html:option value="-1">请选择</html:option>
			</form:select>
		</td>
		...
		<td class="codeCol">
			<form:select property="agreementSend.county" 
				styleId="county" >
				<html:option value="-1">请选择</html:option>
			</form:select>
		</td>
	...
	<tr>
		...
		<td class="codeCol">
			<form:calendar property="agreementSend.back_date" styleId="agreementSend.back_date" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
		</td>
	</tr>
	<tr>

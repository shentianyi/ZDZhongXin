...
function doLoad(){
    ...
    function detail(id){
        location.href="<url:context/>/market/projectCirculationForm.do?method=detailLedger&query.id="+id;
    }
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">项目进驻流转单台账</a>
         </span>
</div>
...
<div class="public-main abs">
    <div class="ly-contai rel">
        <html:form action="/market/projectCirculationForm" styleId="mpcForm" method="post" onsubmit="return false">
            <input name="method" id="method" type="hidden" value="marketProjectListLedger" />
            ...
            <div class="public-main-footer hidden abs">
                <div class="public-main-footer-pagin fr">
                    <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="marketProjectListLedger" action="/market/projectCirculationForm.do?method=marketProjectListLedger" />
                </div>
            </div>
        </html:form>
    </div>

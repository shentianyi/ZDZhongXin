...
<%@page import="com.zd.csms.marketing.contants.ApprovalContant"%>
...
function doLoad(){
	...
	//未审批列表
	function goNotApproval(){
		location.href="<url:context/>/market/projectCirculationForm.do?method=findList&query.pageType=1";
	}
	function detail(id){
...
<c:set var="approval_nopass"><%=ApprovalContant.APPROVAL_NOPASS.getCode() %></c:set>
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                <a class="button fl" href="javascript:goNotApproval();">待审批</a>
...
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/market/projectCirculationForm" styleId="mpcForm" method="post" onsubmit="return false">
			...
			<input type="hidden" name="query.pageType" value="2" />
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<c:if test="${approval_nopass==row.approvalState&&mpcForm.query.currRole == market_commissioner  }">

...
<script>
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/market/payment.do?method=findList";
	}
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/market/payment.do" styleId="paymentForm"
				...
				<input type="hidden" name="query.id" value="<c:out value='${paymentForm.payment.id }'/>"/>
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol">
							<html:text readonly="true" property="payment.actualPaymentMoney"></html:text>
						</td>
					</tr>

			...
			<html:form action="/market/payment.do" styleId="paymentForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol2">
							<form:calendar
								property="payment.paymentDate" styleId="payDate"
						...
						<td class="codeCol2">
							...
							<%-- <input type="text" name="payment.paymentMoney" id="paymentMoney" 
								class="easyui-numberbox" 
								data-options="min:0,precision:2,value:<c:out value='${paymentForm.payment.paymentMoney }'/>"></input> --%>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="codeCol2">
							<form:radios
								property="payment.isArrears" collection="yesorno" styleId="isArrears"></form:radios>
						</td>

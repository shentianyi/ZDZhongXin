		...
		<div class="pagebodyInner">
			<html:form action="/market/dealerExit.do" styleId="deForm"
				...
				<table class="formTable">
					...
					<!------------------------------------- 财务部 ----------------------------------------------------------->
					<c:if test="${deForm.query.currRole!=13&&deForm.query.currRole!=27}">
					<tr class="formTitle">
						<td colspan="4">财务部</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="codeCol">
							<form:radios disabled="true"
								property="de.isArrears" collection="yesorno"></form:radios>
						</td>
					</tr>
					<tr>
					...
					<!------------------------------------- 业务部 ----------------------------------------------------------->
					<c:if test="${deForm.query.currRole!=13
					&&deForm.query.currRole!=27
					&&deForm.query.currRole!=24
					&&deForm.query.currRole!=25}">
					<tr class="formTitle">
						<td colspan="4">业务部</td>
					</tr>
					<tr>
						...
						<td class="codeCol">
							<html:text property="de.businessCommissioner" readonly="true"/>
						</td>
					...
					&&deForm.query.currRole!=24
					&&deForm.query.currRole!=25
					&&deForm.query.currRole!=15
					&&deForm.query.currRole!=16}">
					<tr class="formTitle">
					...
					<tr>
						...
						<td class="codeCol">
							<input type="text" value="<c:out value='${rep.saveAddress }'/>" readonly="readonly"/>
						</td>
					</tr>
				<tr>
					<td class="nameCol">撤店时间：</td>
					...
					<td class="nameCol">备注	：</td>
					<td class="codeCol">
						<html:text property="de.remarkBySupervise" readonly="true"></html:text>
					</td>
				</tr>
				</c:if>

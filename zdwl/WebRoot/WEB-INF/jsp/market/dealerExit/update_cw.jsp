...
<script>
	...
	function doSave() {
		...
		if(!getElement("de.payMoney").value){
			alert("请填写缴费金额");
			return false;
		}
		if(!getElement("de.payMode").value){
			alert("请填写付款方式");
			return false;
		}
		if($("input[name='de\\.isArrears']:checked").val()=='1'){
			if(!getElement("de.arrearsDate").value){
				alert("请填写欠费时间");
				return false;
			}
			if(!getElement("de.arrearsNumber").value){
				alert("请填写欠费金额");
				return false;
			}
		}
		if(!getElement("de.exitDateByFinance").value){
			alert("请选择撤店时间");
			return false;
		}

		if($("input[name='de\\.isArrears']:checked").val()=='2'){
			getElement("de.arrearsDate").value="";
			getElement("de.arrearsNumber").value="";
		}
		...
		<div class="pagebodyInner">
			<html:form action="/market/dealerExit.do" styleId="deForm"
				...
				<table class="formTable">
					...
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>制单日期：</td>
						<td class="codeCol">
							<form:calendar
					...
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>最近一次交费时间：</td>
						<td class="codeCol">
							<form:calendar
						...
						<td class="codeCol">
							<html:text property="de.payMoney" styleId="de.payMoney" />
						</td>
					</tr>
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>付款方式：</td>
						<td class="codeCol">
							<html:text property="de.payMode" styleId="de.payMode"></html:text>
						</td>
						<td class="nameCol"><font color="#FF0000">*</font>是否欠费：</td>
						<td class="codeCol">
							<form:radios styleId="de.isArrears"
								property="de.isArrears" collection="yesorno" onchange="qianfei(this.value)"></form:radios>
						</td>
					</tr>
					<tr id="qianfei">
						...
						<td class="codeCol">
							<html:text property="de.arrearsNumber" styleId="de.arrearsNumber"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>是否需要退费：</td>
						<td class="codeCol">
							<form:radios styleId="de.isRefundByFinance" 
								property="de.isRefundByFinance" collection="yesorno"></form:radios>
						</td>
					...
					<tr>
						<td class="nameCol">备注	：</td>
						<td class="codeCol">
							<html:text property="de.remarkByFinance"></html:text>
						</td>
					</tr>

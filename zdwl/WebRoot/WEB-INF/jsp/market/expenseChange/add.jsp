...
<script src="/pagejs/expenseChange.js"></script>
...
<body>
	...
	<div class="pagebodyOuter" style="width:100%;">
		<div class="pagebodyInner">
			<html:form action="/market/expenseChange.do" styleId="ecForm"
				...
				<table class="formTable">
					...
					<tr>
						<td class="nameCol2"><font color="#FF0000">*</font>制单时间：</td>
						<td class="codeCol2">
							<form:calendar

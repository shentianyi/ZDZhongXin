...
<script>
	...
	//执行保存操作
	function doSave() {
		var value = document.getElementById("unbd.actualinDate").value;
		if(value == ""){
			alert("请填写实际到店时间");
			return false;
		}
		var value = document.getElementById("unbd.trainDate").value;
		if(value == ""){
			alert("请填写培训日期");
			return false;
		}
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/market/unbindDealer.do?method=findList";
	}
			...
			<html:form action="/market/unbindDealer.do" styleId="unbdForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol"><form:radios disabled="true" property="unbd.supervisorSource" collection="supervisorSources"></form:radios></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="codeCol"><html:text property="unbd.systemUid"></html:text></td> --%>
					</tr>
					<%-- <tr>
						<td class="nameCol">系统密码：</td>
						<td class="codeCol">
							<html:text property="unbd.systemPwd"></html:text>
						</td> 

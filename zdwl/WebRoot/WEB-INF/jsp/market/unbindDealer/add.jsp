	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/market/unbindDealer.do" styleId="unbdForm"
				...
				<input type="hidden" name="unbd.changeMoney" id="changeMoneyJson">
				...
				<table class="formTable">
					...
					<tr class="jxsInfo"> 
						...
						<td class="codeCol" >
							<html:text property="unbd.dealerName"  style="width:150px;" styleId="dealerName" readonly="true"></html:text>

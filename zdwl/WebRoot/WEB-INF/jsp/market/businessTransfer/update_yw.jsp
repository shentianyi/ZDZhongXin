...
<script>
	...
	//执行保存操作
	function doSave() {
		var value = document.getElementById("business.actualInDate").value;
		if(value == ""){
			alert("请填写实际到店时间");
			return false;
		}
		var value = document.getElementById("business.trainingDate").value;
		if(value == ""){
			alert("请填写培训日期");
			return false;
		}
			...
			<html:form action="/market/businessTransfer" styleId="btForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol">
							<html:text property="business.pwd" readonly="true"/>
						</td>
					...
					<tr>
						...
						<td class="codeCol">
							<%-- <html:text property="business.businessTraining"  styleId="business.businessTraining"></html:text> --%>
							<form:radios
								property="business.businessTraining" collection="yesorno" 
								styleId="businessTraining"></form:radios>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="codeCol">
							<%-- <html:text property="business.mandateLetterProduction"  styleId="business.mandateLetterProduction"></html:text> --%>
							<form:radios
						...
						<td class="codeCol">
							<%-- <html:text property="business.trainingEffect" styleId="business.trainingEffect"></html:text> --%>
							<form:radios
					...
					<tr>
						<td class="nameCol">备注：</td>
						<td class="codeCol">
							<html:text property="business.businessRemark"></html:text>
						</td>
					</tr>

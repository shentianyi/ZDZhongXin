...
function doLoad(){
    ...
    //执行查询操作
    function doQuery() {
        $("#method").val("dealerFinancialInstitutionBindingLedger");
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">经销商/金融机构绑定台账</a>
         </span>
</div>
...
<div class="public-main abs">
    <div class="ly-contai rel">
        <html:form action="/market/bindDealer.do" styleId="bdForm" method="post" onsubmit="return false">
            <input name="method" id="method" type="hidden" value="dealerFinancialInstitutionBindingLedger" />
            ...
            <div class="public-main-footer hidden abs">
                <div class="public-main-footer-pagin fr">
                    <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="dealerFinancialInstitutionBindingLedger" action="/market/bindDealer.do?method=dealerFinancialInstitutionBindingLedger" />
                </div>
            </div>
        </html:form>
    </div>

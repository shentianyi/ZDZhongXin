...
<body onLoad="doLoad()">
    ...
    <div class="title">经销商/金融机构绑定信息详情</div>
    <hr size="1">
    <br />
            ...
            <html:form action="/market/bindDealer.do" styleId="bdForm"
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="codeCol"><form:radios property="bd.supervisorSource" collection="supervisorSources"></form:radios></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="codeCol"><html:text property="bd.qq"></html:text></td>
                    </tr>
                    <tr>
                        <td class="nameCol">密码：</td>
                        <td class="codeCol">
                            <html:text property="bd.pwd"></html:text>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="codeCol">
                            <html:text property="bd.gqpx"></html:text>
                        </td>
                        <td class="nameCol">晚到原因：</td>
                        <td class="codeCol"><html:text property="bd.laterReason"></html:text></td>
                    </tr>

	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/market/invoice.do" styleId="invoiceForm"
				...
				<html:hidden property="invoice.id" />
				...
				<table class="formTable">
					<tr>
						...
						<td class="codeCol">
						<select style="width: 100%" id="jxs"
							name="invoice.dealerId">
								<c:forEach items="${dealers }" var="row">
									<option
										<c:if test="${invoiceForm.invoice.dealerId==row.value}">selected='selected'</c:if>
					...
					<tr>
						...
						<td class="codeCol"><html:text
								property="invoice.paymentAmount" styleId="invoice.paymentAmount"></html:text>
						</td>
						<td class="nameCol">付费方式：</td>
						<td class="codeCol"><input type="text" id="payMode"
							readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="nameCol">监管费缴费时间：</td>
						<td class="codeCol"><form:calendar
					...
					<tr>
						...
						<td class="codeCol"><html:text property="invoice.office"
								styleId="invoice.office"></html:text></td>
						<td class="nameCol">备注：</td>
						<td class="codeCol"><html:text property="invoice.remark"></html:text>
						</td>
					</tr>

					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>申请人：</td>
						<td class="codeCol"><html:text property="invoice.applicant"
								styleId="invoice.applicant"></html:text></td>
					...
					<tr>
						...
						<td class="codeCol"><html:text property="invoice.accountnum"
								styleId="invoice.accountnum"></html:text></td>
						<td class="nameCol">行号：</td>
						<td class="codeCol"><html:text property="invoice.banknum"
								styleId="invoice.banknum"></html:text></td>
					</tr>
					<tr>
						<td class="nameCol"><font color="#FF0000">*</font>纳税人识别号：</td>
						<td class="codeCol"><html:text property="invoice.taxpayernum"
								styleId="invoice.taxpayernum"></html:text></td>
						<td class="nameCol"><font color="#FF0000">*</font>注册地址：</td>
						<td class="codeCol"><html:text
								property="invoice.registeraddress"
								styleId="invoice.registeraddress"></html:text></td>
					</tr>
					<tr>
						<td class="nameCol">电话：</td>
						<td class="codeCol"><html:text property="invoice.telephone"
								styleId="invoice.telephone"></html:text></td>
						<td class="nameCol"></td>
						<td class="codeCol"></td>
					</tr>

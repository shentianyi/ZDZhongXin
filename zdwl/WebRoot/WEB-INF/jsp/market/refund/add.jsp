			...
			<html:form action="/market/refund.do" styleId="refundForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="nameCol2"><font color="#FF0000">*</font>实收监管费（元/年）：</td>
						<td class="codeCol2">
					...
					<tr>
						...
						<td class="codeCol2">
							<form:radios property="refund.isInvoice" collection="yesorno"></form:radios>
						</td>
						<td class="nameCol2 kaipiao">开票时间：</td>
						<td class="codeCol2 kaipiao">
							<form:calendar
					...
					<tr class="kaipiao">
						...
						<td class="codeCol2">
							<html:text property="refund.invoiceType"></html:text>
						</td>
						<td class="nameCol2">开票单位：</td>
						<td class="codeCol2">
							<html:text property="refund.invoiceCompany"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol2">退费原因：</td>
						<td class="codeCol2">
							<html:text property="refund.refundResource" styleId="refundResource"></html:text>
						</td>
						<td class="nameCol2">申请时间：</td>
						<td class="codeCol2">
							<form:calendar

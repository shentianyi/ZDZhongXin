...
<script>
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/market/refund.do?method=findList";
	}
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/market/refund.do" styleId="refundForm"
				...
				<input type="hidden" name="query.id" value="<c:out value='${refundForm.refund.id }'/>"/>
				...
				<table class="formTable">
					...
					<tr class="kaipiao">
						...
						<td class="codeCol">
							<html:text property="refund.invoiceCompany" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td class="nameCol">退费原因：</td>
						<td class="codeCol">
							<html:text property="refund.refundResource" readonly="true"></html:text>
						</td>

		...
		<span class="add_nav_acolor">
            <a class="crumbs-link" style="color:#929291;" href="#">系统管理与配置</a>
             ...
             <a class="crumbs-link" style="color:#929291;" href="#">资源管理</a>
              &gt;
              <a class="crumbs-link" style="color:#929291;" href="#">修改资源</a>
         </span>
	</div>
<div class="title">修改资源</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/rbac/resource" styleId="resourceForm" method="post" onsubmit="return false">
<input type="hidden" name="method" id="method" value="updResource"/>
<html:hidden property="resource.id" styleId="resource.id"/>
...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol" colspan="3">
			<html:textarea property="resource.des" styleId="resource.des" rows="3" cols="70"></html:textarea>
		</td>
	</tr>

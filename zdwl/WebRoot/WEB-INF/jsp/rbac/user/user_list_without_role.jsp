...
function doSave(){
	...
	if(hasCheckedItem("userIds")){
		...
		showMessage("请选择要添加的人员!");
	}
}

//进入角色下已分配账户页面
function goUserWithRole(){
	location = "<url:context/>/rbac/user.do?method=userListWithRole&roleId=<c:out value="${roleId}"/>&<thumbpage:setQueryFlag tableName="userListWithRole" out="true"/>";
}
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                <a class="button fl" href="javascript:goUserWithRole();">已保存账户</a>
                <a class="button btn-sel fl" href="javascript:void(0);">添加新账户</a>
            </div>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/rbac/user" styleId="userForm" method="post" onsubmit="return false">
			<input type="hidden" name="method" id="method" value="userListWithoutRole" />
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_TAGBAR.getCode()%>" tableName="userListWithoutRole" action="/rbac/user.do?method=userListWithoutRole"/>
				</div>
			</div>
		</html:form>
	</div>

...
function doDel(){
	if(hasCheckedItem("brandIds")){
		...
		showMessage("请选择要删除的品牌!");
	}
}

//分配新品牌
function goAddBrand(id){
	var id=getElement("brandGroup.id").value;
	location = "<url:context/>/rbac/brandGroup.do?method=addBrandEntry&brandGroup.id="+id;
}
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                <a class="button btn-sel fl" href="javascript:void(0);">已分配品牌</a>
                <a class="button fl" href="javascript:goAddBrand();">分配新品牌</a>
            </div>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/rbac/brandGroup" styleId="brandGroupForm" method="post" onsubmit="return false">
			<input type="hidden" name="method" id="method" value="brandEntry" />
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_TAGBAR.getCode()%>" tableName="pageList" action="/rbac/brandGroup.do?method=dealerEntry"/>
				</div>
			</div>
		</html:form>
	</div>

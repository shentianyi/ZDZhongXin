...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/superviseMove.do?method=superviseMoveList";
}
...
<input type="hidden" name="method" id="method" value="updSuperviseMove">
<table class="formTable">
	...
	<tr>
		<td class="nameCol">保证金：</td>
		<td class="codeCol">
			<input type="text" name="superviseImport.bond" id="bond" 
								class="easyui-numberbox" value="<c:out value='${superviseImportForm.superviseImport.bond}'/>"

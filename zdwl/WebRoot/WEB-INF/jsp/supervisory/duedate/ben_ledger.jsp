...
<script>
function detail(id){
	location.href="<url:context/>/duedate.do?method=duedetail&duedate.id="+id;
}
</script>
</head>
<body>
	<div class="title">本库日查库台账</div>
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<div class="tagbarBody">
				<html:form action="/duedate.do" styleId="duedateForm" method="post"
					onsubmit="return false">
					<input name="method" id="method" type="hidden" value="benLedger" />
					...
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="benLedger" action="/duedate.do?method=benLedger" />

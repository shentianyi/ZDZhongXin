...
<script>
	...
	//进入新增页面
	function goAdd() {
		location="<url:context/>/repaircost.do?method=addRepairCostEntry";
	}
	...
	function goAlreadyApproval(){
		location.href="<url:context/>/repaircost.do?method=findList&repaircostquery.pageType=2";
	}
	...
	function approval(id){
		location.href="<url:context/>/repaircost.do?method=preApproval&repaircost.id="+id;
	}
	...
	<div class="ly-contai public-main-input-false rel">
		<html:form action="/repaircost" styleId="repairCostForm" method="post" onsubmit="return false">
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==0 && repairCostForm.repaircostquery.currRole!=80}">
										...
										<c:if test="${repairCostForm.repaircostquery.currRole != sc && row.approvalState==3 &&repairCostForm.repaircostquery.currRole!=80}">
			...
			<div class="public-main-footer hidden abs">
				<c:if test="${repairCostForm.repaircostquery.currRole == sc && repairCostForm.repaircostquery.currRole!=80}">

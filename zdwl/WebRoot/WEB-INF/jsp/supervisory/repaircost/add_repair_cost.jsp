...
function getHistoryRecord(obj){
	if(obj.value==-1){
		return;
	}else{
		getElement("method").value="addRepairCostEntry";
		//提交表单
		document.forms[0].submit();
	}
}
...
<body onLoad="doLoad();" style="height: 100px;">
<div class="title">新增设备维修申请单</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/repaircost" styleId="repairCostForm" method="post" onsubmit="return false">
<input type="hidden" name="method" id="method" value="addRepairCost">
...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol">
			<form:select styleClass="ly-bor-none" property="repaircost.repair_project" styleId="repaircost.repair_project" onchange="getHistoryRecord(this);">
	...
	<tr>
		...
		<td class="codeCol">
			<html:text property="repaircost.money" styleId="repaircost.money" onchange= "if( !/^(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){0,2})?$/.test(this.value)){alert('维修费用只能输入数字，小数点后只能保留两位');this.value='';}"></html:text>
		</td>
	</tr>
...
<div class="public-main-table  abs" style="margin-top:254px;float: left">
...
<div class="public-main-footer-pagin fr" style="margin-top:400px;">
<br>
</br>
<div  class="public-main-footer-pagin fr" style="float:left; position:relative; margin-top:290px;">
	<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="findHistoryList" action="/repaircost.do?method=addRepairCostEntry"/>
</div>
</div>
</html:form>
<br/>

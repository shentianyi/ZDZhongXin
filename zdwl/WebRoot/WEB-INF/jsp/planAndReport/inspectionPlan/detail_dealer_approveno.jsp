...
<script>
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/inspectionPlan.do?method=findListApproveno";
	}
...
<%-- 										<td class="t-td"><c:out value="${row.predictBeginDate}" /></td> --%>
				...
				<div style="margin-top:20px; overflow: hidden;">
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
  							tableName="detail" action="/inspectionPlan.do?method=detailApproveno" />
					</div>
				</div>

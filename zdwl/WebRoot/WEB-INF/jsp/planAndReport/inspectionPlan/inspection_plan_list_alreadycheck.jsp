...
<script>
	...
	function detail(id,planCode,status) {
		location = "<url:context/>/inspectionPlan.do?method=detailAlreadyCheck&inspectionPlan.id=" + id + 
	...
	//已审核列表
	function goOld() {
		location.href = "<url:context/>/inspectionPlan.do?method=findList";
	}
	$(function(){
//限制超级角色操作
    restrict();
...
<!-- 					<a href="javascript:goAdd();" class="button btn-add fl">新增</a> -->
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
 							tableName="list" action="/inspectionPlan.do?method=findListAlreadyCheck" />
					</div>
				</div>
			</html:form>
		</div>

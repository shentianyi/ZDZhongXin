...
<script>
	...
	//执行返回列表操作
	function doReturn() {
		location = "<url:context/>/inspectionPlan.do?method=findListDealerLedgerNo";
	}
				...
				<div style="">
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
  							tableName="detailLedgerNo" action="/inspectionPlan.do?method=detailLedgerNo" />
					</div>
				</div>
				<c:if test="${status==3 || status==4}">
					<jsp:include page="/WEB-INF/jsp/approvalRecord/approvalRecord.jsp"/>
				</c:if>
				<div class="public-main-footer" style="margin: -10px 34% 26px 43%;">

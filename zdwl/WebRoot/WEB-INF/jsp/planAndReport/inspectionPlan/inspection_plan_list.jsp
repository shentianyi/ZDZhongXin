...
<script>
	...
	function goAlreadyCheck() {
		location.href = "<url:context/>/inspectionPlan.do?method=findListAlreadyCheck";
	}
	
	//进入详情页面
	function detail(id,planCode,status) {
		location = "<url:context/>/inspectionPlan.do?method=detail&inspectionPlan.id=" + id + 
				...
				<div class="public-main-footer hidden abs">
					...
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
  							tableName="list" action="/inspectionPlan.do?method=findList" />
					</div>
				</div>
			</html:form>
		</div>

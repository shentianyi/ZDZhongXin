...
<script>
    ...
    function doDel(id) {
        if (confirm("删除后数据不可恢复\n是否继续？")) {
            location = "<url:context/>/videoPlan.do?method=delete&videoPlan.id=" + id;
        }
    }
    ...
    function goAlreadyCheck() {
        ...
        if(planCodeInfo && planCodeInfo > 0){
            location.href = "<url:context/>/videoPlan.do?method=findListAlreadyDealer&videoPlan.planCode=" + planCodeInfo
...
<div class="add_nav">
    ...
    <div class="public-main abs">
        <div class="ly-contai rel" style="margin-top:28px;">
...
<%--                                        <td class="t-td"><c:out value="${index+1}" /></td> --%>
                                        ...
                                        <td class="t-td">
                                            <select:timestamp timestamp="${row.recentCheckTime}" idtype="date"/>
                                        </td>
                                    </tr>
                                </logic:iterate>
                            </tbody>
                ...
                <div class="public-main-footer hidden abs">
                    ...
                    <div class="public-main-footer-pagin fr">
                        <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="list" action="/videoPlan.do?method=preAdd" />
                    </div>
                </div>
            </html:form>
        </div>

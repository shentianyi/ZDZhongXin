		...
		<div class="pagebodyInner">
			<html:form action="/videoReport.do" styleId="videoReportForm"
				...
				<table class="formTable" style="border-bottom: solid 1px #eee;">
					...
					<td class="add_tdText2" style="border-right:1px solid #eee" colspan="2"> <input  readonly="readonly" type="text" name="videoReport.last_check_time" value="<c:out value='${videoReport.last_check_time}'/>" />  </td>
			...
			<tbody id="demoid">
				<logic:iterate name="reportQuestion" id="row" indexId="index">
					...
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="question_classify1">
					...
					<td class="problem_table_td">
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="depart1">
						<option value="-1">未选择</option>
			...
			<tbody id="demoid2">
				...
				<tr  class="demo2">
					<td  class="problem_table_td">
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="question_classify2">
						<option value="-1" >未选择</option>
					...
					<td class="problem_table_td">
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="depart2">
						<option value="-1">未选择</option>
			...
			<logic:iterate name="reportQuestion" id="row3" indexId="index">
				...
				<tr  class="demo3">
					<td class="problem_table_td">
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="question_classify3">
						<option value="-1">未选择</option>
					...
					<td class="problem_table_td">
					<select class="ly-bor-none" disabled="disabled"  id="name_jflx2" name="depart3">
						<option value="-1">未选择</option>

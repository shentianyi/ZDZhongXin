...
$(function(){
	...
	function goWaitApproval(){
		location.href="<url:context/>/leaveApply.do?method=findPageList";
	}
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td"><select:supervisorName repositoryId="${row.leavePerson}" idtype="name" supervisorId="0"/></td>
 									<td class="t-td"><select:dealerInfoByRepositoryId  repositoryId="${row.leavePerson}" idtype="dealerName"/></td>
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==2 && row.status==0  && leaveApplyForm.query.currentRole == 10}">

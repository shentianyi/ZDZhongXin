...
<input type="hidden" name="query.id" value="<c:out value='${leaveApplyForm.leaveApply.id }'/>"/>
<html:hidden property="query.approvalState" styleId="approvalState" value="<c:out value='${leaveApplyForm.leaveApply.approvalState }'/>" />
						...
						<tbody onMouseOver="mouseOver()" onMouseOut="mouseOut()" onClick="clickRow()">
							<logic:iterate name="leaveReplaceDynamicList" id="row" indexId="index" >
								<tr class="listTr_a">
									...
									<td >
										<select:supervisorName repositoryId="${row.replaceSupervisory}" idtype="name" supervisorId="0"/>
									</td>

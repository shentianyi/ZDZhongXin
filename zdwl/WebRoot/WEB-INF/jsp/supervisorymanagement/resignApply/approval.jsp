...
<input type="hidden" name="query.id" value="<c:out value='${resignApplyForm.resignApply.id }'/>"/>
<html:hidden property="query.approvalState" styleId="approvalState" value="<c:out value='${resignApplyForm.resignApply.approvalState }'/>" />

...
<body onLoad="doLoad()">
<div class="title">修改系统账号明细</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/systemSupervise" styleId="systemSuperviseForm" method="post" onsubmit="return false">
<html:hidden property="systemSupervise.id" styleId="systemSupervise.id"/>
<input type="hidden" name="method" id="method" value="updSystemSupervise">

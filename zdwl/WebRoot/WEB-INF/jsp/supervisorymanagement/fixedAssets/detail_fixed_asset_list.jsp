...
function doSave(){
	...
	if(validateMain("fixedAssetListForm")){
		//为时间类型输入项补齐时间戳
		setTimeSuffix();
		//提交表单
...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol">
			...
			<input type="text" readonly="readonly" value='<c:out value="${province }"></c:out>' /> 
		</td>
	</tr>
	<tr>
		...
		<td class="codeCol">
			...
			<input type="text" readonly="readonly" value='<c:out value="${city }"></c:out>' /> 
		</td>

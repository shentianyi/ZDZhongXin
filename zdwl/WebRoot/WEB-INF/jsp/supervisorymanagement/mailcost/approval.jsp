...
<body onLoad="doLoad()">
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/mailcost.do" styleId="mailcostForm"
				...
				<input type="hidden" name="mailcostquery.id" value="<c:out value='${mailcostForm.mailcost.id }'/>"/>
				<html:hidden property="mailcostquery.approvalState" styleId="approvalState"/>
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol" colspan="3">
							<html:textarea property="mailcostquery.remark"></html:textarea>
						</td>
					</tr>

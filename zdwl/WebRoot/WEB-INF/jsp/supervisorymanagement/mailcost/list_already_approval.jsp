...
function goWaitApproval(){
	location.href="<url:context/>/mailcost.do?method=findList";
}
...
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/mailcost" styleId="mailcostForm" method="post" onsubmit="return false">
			...
			<input name="mailcostquery.pageType" value="2" type="hidden"/>
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==2 && mailcostForm.mailcostquery.currRole == 3}">

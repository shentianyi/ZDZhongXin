...
<body class="h-100 public" onLoad="doLoad()">
	<div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/supervisormessage" styleId="/supervisorStorageForm" method="post" onsubmit="return false">
				<input name="method" id="method" type="hidden" value="submit" />
				...
				<a href="javascript:doSubmit();" class="button btn-add fl">提交</a>
					...
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
	  							tableName="list" action="/supervisormessage.do?method=findList" />
					</div>
				</div>
			</html:form>
		</div>

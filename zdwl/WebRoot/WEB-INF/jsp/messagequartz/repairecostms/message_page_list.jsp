...
<script>
	...
	function doClear() {
		...
		$("[name='query.maintenanceitems']").val("");
...
<body class="h-100 public" onLoad="doLoad()">
	<div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/supervisorRepairCost.do" styleId="/supervisorRepairCostForm" method="post" onsubmit="return false">
				...
				<input type="hidden" id="onehiId" value="<c:out value="${supervisorRepairCostForm.query.oneBankId}"/>"/>
				<input type="hidden" id="twohiId" value="<c:out value="${supervisorRepairCostForm.query.twoBankId}"/>"/>
				<input type="hidden" id="threehiId" value="<c:out value="${supervisorRepairCostForm.query.threeBankId}"/>"/>
				...
				<div class="public-main-input ly-col-2 hidden abs" style="height: 165px;margin-top: -50px;">
					<div class="ly-input-w" style="height: 110px;">
						...
						<div class="ly-row clearfix">
							<div class="ly-col fl" style="width:33%;">
								<div class="label block fl hidden">维修类别：</div>
								<div class="input block fl hidden">
									<html:text styleClass="ly-bor-none" property="query.maintenanceitems" styleId="query.maintenanceitems"/>
								</div>
							</div>
	                    </div>
					</div>
							...
							<tbody class="t-tbody">
								<logic:iterate name="list" id="row" indexId="index">
									<tr class="t-tr" <c:if test="${row.isread==1}">style="color:red;"</c:if>>
										...
										<td class="t-td"><c:out value="${row.maintenanceitems}" /></td>
										<td class="t-td"><c:out value="${row.cost}" /></td>
				...
				<div class="public-main-footer hidden abs">
					...
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
  							tableName="findList" action="/supervisorRepairCost.do?method=findList" />
					</div>
				</div>
			</html:form>
		</div>

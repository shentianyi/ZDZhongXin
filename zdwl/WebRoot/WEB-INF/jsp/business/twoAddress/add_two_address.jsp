...
function doSave(){
	...
	var distribid = document.getElementsByName("twoAddress.distribid")[0].value;
	if(distribid == -1){
		alert("请填写经销商");
		return false;
	}
	...
	var type = document.getElementsByName("twoAddress.type")[0].value;
	if(type == -1){
		alert("请选择类别");
		return false;
	}
...
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol">
			<form:select property="twoAddress.type" style="width:70%;" styleId="twoAddress.type">
				<html:option value="-1">请选择</html:option>

...
<body>
<div class="title">新增便签</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/note" styleId="noteForm" method="post" onsubmit="return false">
<input type="hidden" name="method" id="method" value="addNote">
<input type="hidden" name="note.content" id="noteContent"/> 
<table class="formTable">
	<tr>
		<td class="nameCol">标题：</td>
		<td class="codeCol" colspan="3">
			<html:text property="note.title" styleId="title"></html:text>
		</td>
	</tr>
	<tr>

...
function doLoad(){
	...
	function goWaitApproval(){
		location.href="<url:context/>/complaint.do?method=findList";
	}
					...
					<table class="t-table" border="0" cellspacing="0" cellpadding="0">
						<thead class="t-thead">
							<tr class="t-tr">
								...
								<th class="t-th">品牌</th>
								<th class="t-th">投诉人职位</th>
						      	<th class="t-th">投诉人姓名</th>
						      	<th class="t-th">投诉人电话</th>
								<th class="t-th">监管员工号</th>
								<th class="t-th">监管员姓名</th>
								<th class="t-th">监管员电话</th>
						      	<th class="t-th">问题分类</th>
						      	<th class="t-th">投诉内容</th>
								<th class="t-th">处理部门</th>
								<th class="t-th">处理意见</th>
								<th class="t-th">部长意见</th>
						      	<th class="t-th">反馈时间</th>
						      	<th class="t-th">反馈结果</th>
						...
						<tbody class="t-tbody hidden">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td"><c:out value="${row.complainantPhone }" /></td>
									<td class="t-td"><c:out value="${row.staffNo }" /></td>
									<td class="t-td"><c:out value="${row.supervisorName }" /></td>
									<td class="t-td"><c:out value="${row.phone }" /></td>
									<td class="t-td"><select:QuestionSorts idtype="${row.complaintSorts }"></select:QuestionSorts></td>
									<td class="t-td"><c:out value="${row.complaintContent }" /></td>
									<td class="t-td"><select:ClientType idtype="${row.processingDepartment }"></select:ClientType></td>
									<td class="t-td"><c:out value="${row.treatmentOpinion }" /></td>
									<td class="t-td"><c:out value="${row.bzOpinion }" /></td>
									<td class="t-td"><c:out value="${row.returnDate }" /></td>
									<td class="t-td"><c:out value="${row.returnResult }" /></td>
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==2 && complaintForm.query.currRole == business_commissioner }">

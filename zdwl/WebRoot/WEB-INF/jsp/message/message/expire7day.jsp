...
<div class="title">汇票到期前7天提醒</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/message/Expire7dayMessage" styleId="messageForm" method="post" onsubmit="return false">
<input name="method" id="method" type="hidden" value="expire7day"/>
<div class="dvScroll">

...
this.btnList = {
    ...
    "bold":           ['Bold',                 '黑体',               'editor_action(this.id)',  'ed_format_bold.gif'],
    ...
    "justifyleft":    ['JustifyLeft',          '居左',       'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        '居中',     'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         '居右',      'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    '编号',       'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  '项目符号',      'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              '减少缩进量',    'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               '增加缩进量',    'editor_action(this.id)',  'ed_indent_more.gif'],
    ...
    "horizontalrule": ['InsertHorizontalRule', '水平分割',    'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           '插入Web链接',    'editor_action(this.id)',  'ed_link.gif'],
    ...
    "htmlmode":       ['HtmlMode',             '查看源代码',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          '扩大',     'editor_action(this.id)',  'fullscreen_maximize.gif'],

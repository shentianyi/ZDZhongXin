...
<script>
	...
	//执行保存操作
	function doSave() {
		var value = document.getElementById("complaint.solution").value;
		if(value == ""){
			alert("请填写解决方案");
			return false;
		}
			...
			<html:form action="/complaint.do" styleId="complaintForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol2" colspan="3"><html:textarea property="complaint.solution" styleId="complaint.solution" style="width:530px"></html:textarea></td>
					</tr>
					<tr>

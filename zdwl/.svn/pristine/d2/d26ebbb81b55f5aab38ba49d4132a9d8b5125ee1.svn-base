...
<script>
	function detail(id){
		location.href="<url:context/>/ledger/repaircost.do?method=repairCostDetail&repaircost.id="+id;
	}
	//导出
    function goExt(){
       $("#method").val("ExtRepairCostLedger");
...
<div class="public-bar hidden">
	<div class="ly-contai clearfix">
		<div class="public-bar-crumbs fl hidden">
            ...
            > 
            <a class="crumbs-link" href="#">设备维修费用申请台账</a>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai public-main-input-false rel">
		<html:form action="/ledger/repaircost" styleId="repairCostForm" method="post" onsubmit="return false">
			<input name="method" id="method" type="hidden" value="repairCostLedger" />
			...
			<div class="public-main-footer hidden abs">
			    <a href="javascript:goExt();" class="button btn-add fl">导出设备维修费用申请</a>
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="repairCostLedger" action="/ledger/repaircost.do?method=repairCostLedger" />
				</div>
			</div>
		</html:form>
	</div>

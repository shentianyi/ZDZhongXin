...
function doLoad(){
	...
	/* var delivererDealerID=document.getElementById("handoverPlan.delivererDealerID").value;
	changeDealer(delivererDealerID,1); 
	var receiverDealerID=document.getElementById("handoverPlan.receiverDealerID").value;
	changeDealer(receiverDealerID,1); 
...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            <a class="crumbs-link" style="color:#929291;" href="#"> 轮岗计划表</a>
             &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">新增轮岗计划</a>
         </span>
</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
<html:form action="/handoverPlan" styleId="handoverPlanForm" method="post" onsubmit="return false" >
<input type="hidden" name="method" id="method" value="addHandoverPlan"/>

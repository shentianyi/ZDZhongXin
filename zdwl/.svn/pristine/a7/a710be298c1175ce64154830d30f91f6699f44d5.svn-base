...
function ben(){
	location = "<url:context/>/duedate.do?method=benDownLoad";
}
</script>
</head>
<body>

<div class="title">本库日查库</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/duedate" styleId="duedateForm" method="post" onsubmit="return false">
<input name="method" id="method" type="hidden" value="benList"/>
<div class="dvScroll">
...
<table class="bottomTable">
	<tr>
		<td>
			<button class="formButton" onClick="ben()">导出日盘点表</button>&nbsp;

...
//执行返回列表操作
function doReturn(){
	var id=document.getElementsByName("education.supervisorId")[0].value;
...
<input type="hidden" name="method" id="method" value="updSupervisoryEducation"/>
<html:hidden property="education.id" styleId="education.id" />
<html:hidden property="education.supervisorId" styleId="education.supervisorId" />

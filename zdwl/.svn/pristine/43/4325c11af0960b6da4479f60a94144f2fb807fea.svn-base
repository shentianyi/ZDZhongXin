...
public class ExtTwoAddressVO implements Serializable {
	...
	private String distribNTT; //经销商名称
	private String bankfullnameNTT; //金融机构全称
	private String brandNTT; // 品牌名称
	...
	public String getDistribNTT() {
		return distribNTT;
	}
	public void setDistribNTT(String distribNTT) {
		this.distribNTT = distribNTT;
	}
	public String getBankfullnameNTT() {
		return bankfullnameNTT;
	}
	public void setBankfullnameNTT(String bankfullnameNTT) {
		this.bankfullnameNTT = bankfullnameNTT;
	}
	public String getBrandNTT() {
		return brandNTT;
	}
	public void setBrandNTT(String brandNTT) {
		this.brandNTT = brandNTT;
	}

...
public enum RoleConstants {
	 ...
	 * 银行审批人
	 */
	BANK_APPROVE(31,"银行审批人"),
	/**
	 * 经销商集团
	 */
	DEALERMASTER(32, "经销商集团"),
	DEALERMASTERA(143, "经销商集团"),
	/**
	 * 品牌集团
	 */
	BRANDMASTER(33, "品牌集团"),
	...
	private RoleConstants(int code, String name){
		this.code = code;
		this.name = name;
	}
	...
	public static int getCode(String name){
		for(RoleConstants item : RoleConstants.values()){

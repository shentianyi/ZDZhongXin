...
function doLoad(){
	...
	function doExport(){
		$("#method").val("exportDataToExcel");
		document.forms[0].submit();
		$("#method").val("findAllList");
	}
	
	function detail(id){
		location.href="<url:context/>/ledger/businessTransfer.do?method=detailPage&&business.id="+id;
	}
	$(function(){
		initTools();
	});
...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">业务流转单台账</a>
         </span>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/ledger/businessTransfer.do" styleId="btForm" method="post" onsubmit="return false">
			<input name="method" id="method" type="hidden" value="findAllList" />
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="btlist" action="/ledger/businessTransfer.do?method=findAllList" />
				</div>
			</div>
		</html:form>
	</div>

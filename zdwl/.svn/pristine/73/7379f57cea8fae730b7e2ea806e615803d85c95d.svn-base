...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/rbac/user.do?method=jgyuserList";
}
...
<input type="hidden" name="method" id="method" value="addjgyUser">
<html:hidden property="user.client_id" styleId="user.client_id"/>
<input type="hidden" name="user.client_type" id="user.client_type" value="3">
<table class="formTable">
	...
	<tr>
		...
		<td class="codeCol"><html:password property="user.password" styleId="user.password"/></td>
	...
	<tr>
		<td class="nameCol">选择部门：</td>
		<td class="codeCol">监管员</td>

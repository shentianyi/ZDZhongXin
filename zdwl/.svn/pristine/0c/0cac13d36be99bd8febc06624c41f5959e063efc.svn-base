		...
		<html:form action="/message/supMaMsg" styleId="messageForm" method="post" onsubmit="return false">
			...
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl" >
                        <div class="label block fl hidden">面试时间：</div>
                        <div class="input block fl hidden">
                        	<form:calendar property="supMaQuery.interviewTime" styleId="interviewTime" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
                        </div>
                    </div>
                    <div class="ly-col fl">
                        <div class="label block fl hidden">意向城市：</div>
                        <div class="input block fl hidden">
                        	 <html:text styleClass="ly-bor-none" property="supMaQuery.intentionCity" styleId="intentionCity"/>
                        </div>
                    </div>
				</div>
			</div>
					...
					<table class="t-table" border="0" cellspacing="0" cellpadding="0">
						<thead class="t-thead">
							<tr class="t-tr">
								...
								<th class="t-th">面试时间</th>
								<th class="t-th">意向城市</th>
								<th class="t-th">
						...
						<tbody class="t-tbody hidden">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<select:timestamp timestamp="${row.interviewTime}" idtype="date"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.intentionCity}"/>
										</font>
									</td>
									<td class="t-td">

...
function doLoad(){
	...
	var nativePlaceProvince=document.getElementsByName("baseInfo.nativePlaceProvince")[0].value;
	initProvince(nativePlaceProvince,$("#nativePlaceProvince"));
	
	var nativePlaceCity=document.getElementsByName("baseInfo.nativePlaceCity")[0].value;
	changeProvince(nativePlaceProvince,nativePlaceCity,$('#nativePlaceCity'),$("#nativePlaceProvince"));
	
	var nativePlaceCounty=document.getElementsByName("baseInfo.nativePlaceCounty")[0].value;
	changeProvince(nativePlaceCity,nativePlaceCounty,$('#nativePlaceCounty'),$("#nativePlaceCity"));
	
	var liveAddressProvince=document.getElementsByName("baseInfo.liveAddressProvince")[0].value;
	initProvince(liveAddressProvince,$("#liveAddressProvince"));
	
	var liveAddressCity=document.getElementsByName("baseInfo.liveAddressCity")[0].value;
	changeProvince(liveAddressProvince,liveAddressCity,$('#liveAddressCity'),$("#liveAddressProvince"));
	
	var liveAddressCounty=document.getElementsByName("baseInfo.liveAddressCounty")[0].value;
	changeProvince(liveAddressCity,liveAddressCounty,$('#liveAddressCounty'),$("#liveAddressCity"));
	
	$("#registeredAddres").val("<%=request.getAttribute("registeredAddres")%>");
	$("#liveAddres").val("<%=request.getAttribute("liveAddres")%>");
}
...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">修改监管员基本信息</a>
         </span>
	</div>
...
<input type="hidden" name="method" id="method" value="updSupervisoryBaseInfo"/>
<html:hidden property="baseInfo.id" styleId="baseInfo.id" />
<html:hidden property="baseInfo.nativePlaceProvince" styleId="nativePlaceProvince1" />
<html:hidden property="baseInfo.nativePlaceCity" styleId="nativePlaceCity1" />
<html:hidden property="baseInfo.nativePlaceCounty" styleId="nativePlaceCounty1" />
<html:hidden property="baseInfo.liveAddressProvince" styleId="liveAddressProvince1" />
<html:hidden property="baseInfo.liveAddressCity" styleId="liveAddressCity1" />
<html:hidden property="baseInfo.liveAddressCounty" styleId="liveAddressCounty1" />
<html:hidden property="baseInfo.createUser" styleId="baseInfo.createUser" />
<html:hidden property="baseInfo.createTime" styleId="baseInfo.createTime" />
<html:hidden property="baseInfo.lastModifyUser" styleId="baseInfo.lastModifyUser" />
<html:hidden property="baseInfo.lastModifyTime" styleId="baseInfo.lastModifyTime" />
<html:hidden property="baseInfo.pictureId" styleId="baseInfo.pictureId" />
<table class="formTable">
	<tr class="formTitle">
		<td colspan="4">修改监管员基本信息</td>
	</tr>
	<tr>
			...
			<table>
				<tr>
					...
					<td class="codeCol" style="width: 180px;">
						<select id="nativePlaceProvince" name="nativePlaceProvince" onchange="changeProvince(this.value,-1,$('#nativePlaceCity'),$('#nativePlaceProvince1'))" >
							<option value="-1">请选择</option>
						</select>
					</td>
					<td class="nameCol" style="width: 200px;">户口所在地（市）：</td>
					<td class="codeCol">
						<select id="nativePlaceCity" onchange="changeProvince(this.value,-1,$('#nativePlaceCounty'),$('#nativePlaceCity1'))" 
								name="nativePlaceCity">
							<option value="-1">请选择</option>		
						</select>
					</td>
					<td class="nameCol" style="width: 260px">户口所在地（县/区）：</td>
					<td class="codeCol">
						<select id="nativePlaceCounty" onchange="changeCity(this.value,$('#nativePlaceCounty1'))" 
				...
				<tr>
					<td class="nameCol"style="width: 300px">户口所在地详细地址：</td>
				...
				<tr>
					...
					<td class="codeCol">
						<select id="liveAddressProvince" name="liveAddressProvince" onchange="changeProvince(this.value,-1,$('#liveAddressCity'),$('#liveAddressProvince1'))"  >
							<option value="-1">请选择</option>
						</select>
					</td>
					<td class="nameCol" style="width: 200px;"><font color="#FF0000">*</font>现住址（市）：</td>
					<td class="codeCol">
						<select id="liveAddressCity" name="liveAddressCity"  onchange="changeProvince(this.value,-1,$('#liveAddressCounty'),$('#liveAddressCity1'))" >
							<option value="-1">请选择</option>
						</select>
					</td>
					<td class="nameCol" style="width: 200px"><font color="#FF0000">*</font>现住址（县/区）：</td>
					<td class="codeCol">
						<select id="liveAddressCounty" name="liveAddressCounty"  onchange="changeCity(this.value,$('#liveAddressCounty1'))">
							<option value="-1">请选择</option>
						</select>
					</td>
				</tr>
				<tr>
					<td class="nameCol" style="width: 300px"><font color="#FF0000">*</font>现居住详细地址</td>
					<td class="codeCol" colspan="6" style="text-align: left;">

...
//执行返回列表操作
function doReturn(){
	var id=document.getElementsByName("workExperience.supervisorId")[0].value;
...
<input type="hidden" name="method" id="method" value="updSupervisoryWorkExperience"/>
<html:hidden property="workExperience.id" styleId="workExperience.id" />
<html:hidden property="workExperience.supervisorId" styleId="workExperience.supervisorId" />
<table class="formTable">
	<tr class="formTitle">
		<td colspan="4">修改监管员工作经历</td>
	</tr>
	<tr>
		<td colspan="4">
			<table >

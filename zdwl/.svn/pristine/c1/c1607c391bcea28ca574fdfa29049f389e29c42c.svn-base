...
<script>
	...
	//执行保存操作
	function doSave() {
		if(!getElement("businessCommissioner").value){
			alert("请填写业务专员");
			return false;
		}
		if(!getElement("de.exitDateByBusiness").value){
			alert("请填写撤店时间");
			return false;
		}
			...
			<html:form action="/market/dealerExit.do" styleId="deForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol">
							<html:text property="de.businessCommissioner"  styleId="businessCommissioner" />
						</td>

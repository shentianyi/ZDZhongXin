...
<div class="title">连续三天出库5台以上</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/message/Continuity3outMessage" styleId="messageForm" method="post" onsubmit="return false">
<input name="method" id="method" type="hidden" value="continuity3out"/>
<div class="dvScroll">
<table  class="listTalbe" cellpadding="0" cellspacing="0">
	<thead>
		<tr class="title">
	      ...
	      <td><thumbpage:order cname="上月平均出库台数" filedName="name"/></td>
	      <td><thumbpage:order cname="最近3天平均出库台数" filedName="name"/></td>
	...
	<tbody onMouseOver="mouseOver()" onMouseOut="mouseOut()" onClick="clickRow()">
		<tr class="listTr_a">
			...
			<td align="center"><c:out value="${ypj}"/></td>
			<td align="center"><c:out value="${threepj}"/></td>

...
function doLoad(){
    ...
    //执行查询操作
    function doQuery() {
        $("#method").val("dealerFinancialInstitutionLedger");
    ...
    function detail(id){
        location.href="<url:context/>/market/unbindDealer.do?method=detailLedgerPage&unbd.id="+id;
    }
    $(function(){
    //限制超级角色操作
        restrict();
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">经销商/金融机构拆绑台账</a>
         </span>
</div>
...
<div class="public-main abs">
    <div class="ly-contai rel">
        <html:form action="/market/unbindDealer.do" styleId="unbdForm" method="post" onsubmit="return false">
            <input name="method" id="method" type="hidden" value="dealerFinancialInstitutionLedger" />
            ...
            <div class="public-main-footer hidden abs">
                ...
                <div class="public-main-footer-pagin fr">
                    <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="dealerFinancialInstitutionLedger" action="/market/unbindDealer.do?method=dealerFinancialInstitutionLedger" />
                </div>
            </div>
        </html:form>
    </div>

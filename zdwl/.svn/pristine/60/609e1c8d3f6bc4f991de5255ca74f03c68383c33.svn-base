...
<div class="public-bar hidden">
	<div class="ly-contai clearfix">
		<div class="public-bar-crumbs fl hidden">
            ...
            > 
            <a class="crumbs-link" href="#">出质入库通知书详情查询</a>
        </div>
	</div>
</div>
	...
	<div class="ly-contai rel">
		...
		<div class="public-main-input ly-col-2 hidden abs">
			<div class="ly-input-w" style="height:110px">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl">
                        <div class="label block fl hidden">先票后货协议号：</div>
	                    <div class="input block fl hidden">
	                    	<c:out value='${fourProtocolCode}'/>
	                    </div>
                    </div>
                    <div class="ly-col fl">
                ...
                <div class="ly-row clearfix">
                    <div class="ly-col fl">
                        <div class="label block fl hidden">敞口额度：</div>
	                    <div class="input block fl hidden">
	                    	<c:out value='${exposureAmount}'/>
	                    </div>
                    </div>
                    <div class="ly-col fl">
                        <div class="label block fl hidden">抵质押率：</div>
	                    <div class="input block fl hidden">
	                    	<c:out value='${ration}'/>
	                    </div>
                    </div>
						...
						<c:if test="${not empty list }">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<%-- <td class="t-td"><c:out value='${row.confirmPrice }'/></td> --%>
									<%-- <td class="t-td"><c:out value='${row.totPrice }'/></td> --%>
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<c:if test="${not empty list }">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="gyl017" action="/bank/interface.do?method=gyl017" />
				</c:if>
			</div>
		</div>
		</html:form>

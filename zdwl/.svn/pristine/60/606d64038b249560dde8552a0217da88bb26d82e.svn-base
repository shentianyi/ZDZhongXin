...
<div class="public-bar hidden">
	<div class="ly-contai clearfix">
		<div class="public-bar-crumbs fl hidden">
            ...
            > 
            <a class="crumbs-link" href="#">申请信息明细查询</a>
        </div>
	</div>
</div>
	...
	<div class="ly-contai rel">
			...
			<div class="ly-input-w">
				...
				<div class="ly-row clearfix">
					<div class="ly-col fl">
	                    ...
	                    <div class="input block fl hidden">
	                    	<c:if test="${applyType=='2116'}">先票后货出质入库申请</c:if>
							<c:if test="${applyType=='2122'}">先票后货提货申请</c:if>
	                    </div>
                    </div>
                    <div class="ly-col fl">
		...
		<div class="public-main-footer hidden abs">
			<div class="public-main-footer-pagin fr">
				<c:if test="${not empty list }">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="gyl007" action="/bank/interface.do?method=gyl007" />
				</c:if>
			</div>
		</div>
		</html:form>

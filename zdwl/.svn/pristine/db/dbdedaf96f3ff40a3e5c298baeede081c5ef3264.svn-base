...
$(function(){
	...
	function detail(id){
		location.href="<url:context/>/ledger/resignApply.do?method=detailPage&resignApply.id="+id;
	}
	//执行查询操作
	function doQuery(){
...
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/ledger/resignApply" styleId="resignApplyForm" method="post" onsubmit="return false">
			...
			<div class="ly-input-w" style="margin-top:30px;margin-bottom:-10px">
				<div class="ly-row clearfix">
					...
					<div class="ly-col fl" style="width: 17%">
                        <div class="label block fl hidden"style="width: 32%">申请日期：</div>
                        <div class="input block fl hidden"style="width: 68%">
                    ...
                    <div class="ly-col fl" style="width: 33%">
                        <div class="label block fl hidden"style="width: 20%">审批状态：</div>
                        <div class="input block fl hidden"style="width: 80%">
			...
			<div class="public-main-footer hidden abs">
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="resignList" action="/ledger/resignApply.do?method=findPageList" />
				</div>
			</div>
		</html:form>
	</div>

...
function goDetail(id){
	window.location="<url:context/>/roster.do?method=getRosterDetail&roster.id="+id;
}
//修改
function goUpd(id){
	window.location="<url:context/>/roster.do?method=updRosterEntity&roster.id="+id;
}
//进入岗位转换列表页
function goPostChangeList(id){
	window.location="<url:context/>/roster.do?method=postChangeList&roster.id="+id;
}

//执行删除操作
function doDel(id){
	if(confirm("确认删除？")){
		window.location="<url:context/>/roster.do?method=delRoster&roster.id="+id;
	}
}
//导出
function goExport(){
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<input name="method" id="method" type="hidden" value="rosterPageList"/>
					...
					<tbody class="t-tbody hidden">
						<logic:iterate name="list" id="row" indexId="index">
							<tr class="t-tr">
								...
								<td class="t-td">
									<a href="javascript:goPostChangeList('<c:out value='${row.roster.id}'/>');" class="yc">岗位轮换列表</a>&nbsp;
									<a href="javascript:goUpd('<c:out value='${row.roster.id}'/>');" class="yc">修改</a>&nbsp;
		...
		<div class="public-main-footer hidden abs">
			...
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="rosterList" action="/roster.do?method=rosterPageList"/>
			</div>
		</div>
		</html:form>
	</div>

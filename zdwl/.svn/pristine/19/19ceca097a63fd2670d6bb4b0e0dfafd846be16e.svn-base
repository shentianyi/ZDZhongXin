 ...
 *
 */
@table(name = "t_businWaring_info")
public class BusinWaringInfoVO extends WaringInfoVO {

	private static final long serialVersionUID = -5747390135892662946L;
	private int id;// 主键id
	...
	public void noMortgageCarMoneyForTen(){
		...
		if(yycMoney>0&&StringUtil.isNotEmpty(mortgagecar_money)){

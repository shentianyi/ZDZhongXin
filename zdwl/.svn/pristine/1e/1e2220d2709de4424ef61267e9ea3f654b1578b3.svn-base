...
//执行返回列表操作
function doReturn(){
    location = "<url:context/>/dataMailcost.do?method=dataMailingFeeList";
}
...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="codeCol">
            <form:select property="dataMailcost.mailPersonDealer" styleId="mailPersonDealer"disabled="true" onchange="changeMailPersonDealer(this.value)">
    ...
    <tr>
        ...
        <td class="codeCol" colspan="3">
            <form:select property="dataMailcost.receiverType" styleId="dataMailcost.receiverType"disabled="true" onchange="changeReceiverType(this.value)">
                <html:option value="-1">请选择</html:option>

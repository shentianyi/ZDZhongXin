...
function Node(id, pid, code, name, url, title, target, icon, iconOpen, open) {
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		if(nodeId!=0){
			str += '<input type="checkbox" style="height:16px;width:16px;" name="'+this.obj+'" value="'+node.code+'" valueName="'+node.name+'" onclick="checkRadioButton()">';
		}
	}

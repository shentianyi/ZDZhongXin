...
<script>
	//进入详情页面//
	function detail(id) {
		location = "/ledger/videoReport.do?method=getDetail&id="+ id;
     }
     //导出
	function goExt(){
	   $("#method").val("ExtReportLedger");
	    document.forms[0].submit();
	}
</script>
</head>
<body class="h-100 public" onLoad="doLoad(false)">
<div class="add_nav">
	<span class="add_nav_acolor">
            <a class="crumbs-link" style="color:#929291;" href="#">视频管理</a>
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">视频检查报告台账</a>
         </span>
</div>
   <div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/ledger/videoReport.do" styleId="videoReportForm"
				method="post" onsubmit="return false">
				<input name="method" id="method" type="hidden" value="reportLedger" />
				...
				<input type="hidden" id="cityhiId"
					...
					value="<c:out value="${videoReportForm.query.userVO.client_type}"/>" />
				...
				<div class="public-main-input ly-col-2 hidden abs" style="overflow: visible;">
					<div class="ly-input-w" style="margin-top:10px;margin-bottom:-10px;height: 130px;">
						<div class="ly-row clearfix">
							<!-- <div class="ly-col fl">
								<div style="height:24px;padding: 0 auto;" class="ly-bor-none label block fl hidden">总行/金融机构：</div>
						...
						<div class="ly-row clearfix">
							...
							<div class="ly-col fl">
								...
								<div class="input block fl hidden">
									<html:text styleClass="ly-bor-none" property="query.videoUserName"
										styleId="query.videoUserName" />
								</div>
							</div>
						</div>
						<div class="ly-row clearfix">
							<div class="ly-col fl" style="width: 50%;">
								...
								<div class="input block fl hidden"
								  ...
								  <input style="width: 28%;"
										...
										name="query.submitTimeEnd" type="text" 
									value='<fmt:formatDate value="${videoReportForm.query.submitTimeEnd }" pattern="yyyy-MM-dd"/>' />
								</div>
							</div>
							...
							<div class="ly-col fl">
								...
								<div class="input block fl hidden">
									<html:text styleClass="ly-bor-none" property="query.brandName"
										styleId="query.brandName" />
						      	</div>
	                    	</div>
						</div>
					</div>
					<div class="ly-button-w" style="margin-top:-10px;">
						<a href="javascript:doQuery();" class="button btn-query">查询</a> <a
							href="javascript:doClear(false);" class="button btn-reset">重置</a>
					</div>
				</div>
				<div class="public-main-table hidden abs" style="margin-top:20px;">
					<div class="ly-cont">
						<table class="t-table" border="0" cellspacing="0" cellpadding="0">
							<thead class="t-thead">
								<tr class="t-tr">
									<th class="t-th">序号</th>
									<th class="t-th">视频检查专员</th>
				...
				<div class="public-main-footer hidden abs">
				    <a href="javascript:goExt();" class="button btn-add fl">导出视频检查报告台账</a>
                    <div class="public-main-footer-pagin fr">
						<thumbpage:tools
							className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>"
							tableName="pagelist" action="/ledger/videoReport.do?method=reportLedger" />
					</div>
				</div>
			</html:form>
		</div>

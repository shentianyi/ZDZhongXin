...
<input type="hidden" name="method" id="method" value="updPostChange"/>
<html:hidden property="roster.id" styleId="roster.id" />
<html:hidden property="postChange.id" styleId="postChange.id" />
<html:hidden property="postChange.rosterId" styleId="postChange.rosterId" />

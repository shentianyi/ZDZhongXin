			...
			<html:form action="/market/projectCirculationForm" styleId="mpcForm"
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol">
							<html:text readonly="true" style="width:80%;" property="mpc.dealerName"></html:text>
						</td>
					...
					<tr>
						...
						<td class="codeCol">
							<form:radios styleId="supervisionMode" disabled="disabled"
					...
					<tr>
						...
						<td class="codeCol"><form:radios property="mpc.isBindShop" 
								collection="yesorno" disabled="true"></form:radios></td>
						<td class="nameCol">是否提供午餐：</td>
						<td class="codeCol"><form:radios property="mpc.provideLunch" 
								collection="yesorno" disabled="true"></form:radios></td>
					</tr>
					...
					<tr>
						...
						<td class="codeCol">
							<form:radios collection="yesorno" property="mpc.isSignAnAgreement" disabled="true"></form:radios>
						</td>
						<td class="nameCol agreementIsRecovery">协议是否回收：</td>
						<td class="codeCol agreementIsRecovery">
							<form:radios collection="yesorno" property="mpc.agreementIsRecovery" disabled="true"></form:radios>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="codeCol" colspan="3">
							<html:textarea  property="query.approvalRemark"></html:textarea>
						</td>
					</tr>

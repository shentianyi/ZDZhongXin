...
//执行查询操作
function goReturn(){
	location = "<url:context/>/rbac/resource.do?method=resourceListEntry";
}
...
<div class="public-bar hidden">
	<div class="ly-contai clearfix">
		<div class="public-bar-crumbs fl hidden">
            ...
            > 
            <a class="crumbs-link" href="#">资源管理</a>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai public-main-input-false rel">
		...
		<input name="method" id="method" type="hidden" value="resourceListByParent"/>
		...
		<div class="public-main-footer hidden abs">
			<a href="javascript:goReturn();" class="button btn-add fl">返回</a>
		</div>
		</html:form>
	</div>
</div>

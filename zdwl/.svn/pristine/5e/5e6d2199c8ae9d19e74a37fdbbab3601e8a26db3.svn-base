...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/ledger/roster.do?method=rosterLedger";
}
...
<html:form action="/ledger/roster" styleId="rosterForm" method="post" onsubmit="return false" enctype="multipart/form-data">
<input type="hidden" name="method" id="method" value="rosterDetail"/>
...
<table class="formTable"  >
	...
	<tr class="formTitle" style="width:100%">
		<td colspan="4"> 
			<table style="width:100%">
				...
				<tr>
					...
					<td class="codeCol" colspan="2" >
						<select id="dispatchCity1" onchange="changeCity(this.value,$('#dispatchCity'))" disabled="true"
								name="dispatchCity1">

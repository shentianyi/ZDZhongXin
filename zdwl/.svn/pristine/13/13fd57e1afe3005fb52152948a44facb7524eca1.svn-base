...
<script>
	...
	function setDealer(dealer){
		...
		$("#inDate").val(tDate.getFullYear()+"-"+(tDate.getMonth()+1)+"-"+tDate.getDate());
	}
</script>
</head>
<body onLoad="doLoad()">
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/supervisor/checkStock.do" styleId="checkStockForm"
				...
				<html:hidden property="checkStock.id"/>
				...
				<table class="formTable">
					<tr>
						...
						<td class="codeCol">
							<select:timestamp timestamp="${checkStockForm.checkStock.createDate}" idtype="date"/>
						</td>
					</tr>
					<tr>

...
//进入新增页面
function goAdd(){
	location="<url:context/>/brand.do?method=addBrandEntry";
}

//进入修改页面
function goUpd(id){
	location = "<url:context/>/brand.do?method=updBrandEntry&brand.id="+id;
}

//执行删除操作
function doDel(id){
	if(confirm("删除后数据不可恢复\n是否继续？")){
		location="<url:context/>/brand.do?method=delBrand&brand.id="+id;
	}
}
...
function doClear(){
	//清空资源名输入框
	getElement("brandquery.name").value="";
}
$(function(){
    restrict();
});
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<input name="method" id="method" type="hidden" value="brandList"/>
				...
				<div class="ly-row clearfix">
					<div class="ly-col fl">
                        ...
                        <div class="input block fl hidden">
                       		<html:text styleClass="ly-bor-none"  property="brandquery.name" styleId="brandquery.name"/>
                        </div>
                    </div>
                    <div class="ly-col fl">
		...
		<div class="public-main-footer hidden abs">
			...
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="brandList" action="/brand.do?method=brandList"/>
			</div>
		</div>
		</html:form>
	</div>

...
<html:hidden property="mailcost.promoter" styleId="mailcost.promoter"/>
<html:hidden property="mailcost.nextApproval" styleId="mailcost.nextApproval"/>
<html:hidden property="mailcost.approvalState" styleId="mailcost.approvalState"/>
<html:hidden property="mailcost.createuserid" styleId="mailcost.createuserid"/>
<html:hidden property="mailcost.createdate" styleId="mailcost.createdate"/>
...
<table class="formTable">
	...
	<tr id="mailcostParts" hidden="hidden">
		...
		<td class="codeCol" colspan="3">
			<input style="width:60%;" type="text"  name="mailcost.parts" id="part" value="<c:out value='${mailcostForm.mailcost.parts}'/>"/>
		</td>
	</tr>
	<tr id="mailcostOther" hidden="hidden">
		<td class="nameCol"><font color="#FF0000">*</font>其他：</td>
		<td class="codeCol" colspan="3">
			<input style="width:60%;" type="text"  name="mailcost.other" id="other" value="<c:out value='${mailcostForm.mailcost.other}'/>"/>
		</td>
	</tr>
	<tr>
		...
		<td class="codeCol">
			...
			<c:forEach items="${superviseOptions }" var="row">
				<option <c:if test="${mailcostForm.mailcost.mailperson==row.value}">selected='selected'</c:if> value="<c:out value='${row.value }'/>"><c:out value="${row.label }"/></option>
			</c:forEach>
		</td>
	...
	<tr>
		...
		<td class="codeCol">
			...
			<option value="-1">请选择</option>
			<c:forEach items="${superviseOptions }" var="row">
				<option <c:if test="${mailcostForm.mailcost.receiveid==row.value}">selected='selected'</c:if> value="<c:out value='${row.value }'/>"><c:out value="${row.label }"/></option>
			</c:forEach>
		</td>
		<td class="nameCol">工号：</td>
		<td class="codeCol">

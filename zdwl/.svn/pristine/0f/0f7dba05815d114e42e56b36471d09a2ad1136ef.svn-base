...
function doLoad(){
	...
	function goWaitApproval(){
		location.href="<url:context/>/market/expenseChange.do?method=findList";
	}
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<span class="yc"><c:if   test="${row.approvalState==2 && ecForm.query.currRole == market_commissioner }"></span>

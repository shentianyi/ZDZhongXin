...
<div class="title">开票30天汇票未押满</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/message/Billing30nofullMessage" styleId="messageForm" method="post" onsubmit="return false">
<input name="method" id="method" type="hidden" value="billing30nofull"/>
<div class="dvScroll">
<table  class="listTalbe" cellpadding="0" cellspacing="0">
	<thead>
		<tr class="title">
	      ...
	      <td><thumbpage:order cname="未押车" filedName="name"/></td>
	    </tr>
	</thead>
	<tbody onMouseOver="mouseOver()" onMouseOut="mouseOut()" onClick="clickRow()">
		<tr class="listTr_a">
			...
			<td align="center"><select:draft draftid="${draft.id}" idtype="wycje"/></td>
		</tr>
	</tbody>  
</table>
</div>

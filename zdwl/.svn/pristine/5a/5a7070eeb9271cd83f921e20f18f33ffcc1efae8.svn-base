...
<script>
	...
	function goAlreadyApproval(){
		location.href="<url:context/>/carOperation.do?method=storagefindList&carOperationquery.pageType=2";
	}
	
	function approval(id){
		location.href="<url:context/>/carOperation.do?method=storagePreApproval&carOperation.id="+id;
	}
		...
		<div class="pagebodyInner">
			...
			<div class="tagbarBody">
				<html:form action="/carOperation" styleId="carOperationForm" method="post" onsubmit="return false">
					<input name="method" id="method" type="hidden" value="storagefindList" />
					<div class="dvScroll">
					...
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="storagefindList" action="/carOperation.do?method=storagefindList" />

 ...
 */
public class DistridNameIdTypeTagExtraInfo extends TagExtraInfo{

	public boolean isValid(TagData data){
		boolean flag=false;
		Object o = data.getAttribute("idType");
		if(o==null){
			o=DistridNameIdTypeConstants.DISTRIB.getCode();
		}
		if(o != TagData.REQUEST_TIME_VALUE){
			for(DistridNameIdTypeConstants idTypeConstants: DistridNameIdTypeConstants.values()){

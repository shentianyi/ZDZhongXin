...
//进入新增页面
function goAdd(){
	window.location="<url:context/>/transfer.do?method=addTransferEntity";
}

//进入修改页面
function goUpd(id){
	window.location="<url:context/>/transfer.do?method=updTransferEntity&transfer.id="+id;
}
//进入监管员列表页面
function goTransferList(dealerId){
	window.location="<url:context/>/transfer.do?method=getSupervisorListByTransferId&transfer.dealerId="+dealerId;
}

//执行删除操作
function doDel(id){
	if(confirm("确认删除？")){
		window.location="<url:context/>/transfer.do?method=delTransfer&transfer.id="+id;
	}
}
//导出
function goExport(){
...
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/transfer" styleId="transferForm" method="post" onsubmit="return false">
		<input name="method" id="method" type="hidden" value="transferPageList"/>
		...
		<div class="public-main-footer hidden abs">
			...
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="transferList" action="/transfer.do?method=transferPageList"/>
			</div>
		</div>
		</html:form>
	</div>

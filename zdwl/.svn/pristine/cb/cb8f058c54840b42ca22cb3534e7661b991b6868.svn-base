...
function doLoad(){
    ...
    //执行查询操作
    function doQuery() {
        $("#method").val("DealerWithdrawalLedger");
    ...
    function detail(id){
        location.href="<url:context/>/market/dealerExit.do?method=detailLedgerPage&de.id="+id;
    }
    $(function(){
        initTools();
    });
...
<div class="add_nav">
    <span class="add_nav_acolor">
            ...
            &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">经销商撤店台账</a>
         </span>
</div>
        ...
        <html:form action="/market/dealerExit.do" styleId="deForm" method="post" onsubmit="return false">
            ...
            <div class="public-main-footer hidden abs">
                <div class="public-main-footer-pagin fr">
                    <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="DealerWithdrawalLedger" action="/market/dealerExit.do?method=DealerWithdrawalLedger" />
                </div>
            </div>
        </html:form>
    </div>

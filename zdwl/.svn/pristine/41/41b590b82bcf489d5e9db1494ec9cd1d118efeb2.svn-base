		...
		<td colspan="4"> 
			<table style="width: 100%">
				...
				<tr>
					...
					<td class="codeCol" >
						<input type="text" id="extraWorkDays" name="extraworkApply.extraWorkDays" class="easyui-numberbox" value="<c:out value='${extraworkApplyForm.extraworkApply.extraWorkDays}'/>" readonly="readonly"

				...
				<input type="hidden" id="idsShield" name="idsShield" />
                 ...
                 <div class="public-main-input ly-col-2 hidden abs"
					...
					<div class="ly-input-w" style="height: 110px;">
					    ...
					    <div class="ly-row clearfix">
						   		<div class="ly-col fl" style="width: 36%; display:none ;" id="mailingTimeQuery">
								<div class="label block fl hidden"
							...
							<div class="ly-col fl" style="width: 33%; display:none ;" id="protocolExpireQuery">	
							  <div class="label block fl hidden"
								...
								<div class="input block fl hidden"
									...
									<span>至</span> <input style="width: 24%;" class="ly-bor-none allDate"
                            ...
                            <div class="ly-button-w" style="margin-top: 25px;">
						      <a href="javascript:doWaringQuery();" class="button btn-query">查询</a> 
						      <a href="javascript:doWaringClear();" class="button btn-reset">重置</a>
				            </div> 
					</div>

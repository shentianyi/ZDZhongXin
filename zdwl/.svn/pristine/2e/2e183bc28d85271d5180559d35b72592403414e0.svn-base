...
function goOld(){
	location.href="<url:context/>/superviseOut.do?method=superviseOutList";
}
</script>
</head>
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                <a class="button fl" href="javascript:goOld();">监管物出库</a>
                <a class="button btn-sel fl" href="javascript:void(0);">监管物出库申请中</a>
            </div>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/superviseOut" styleId="superviseImportForm" method="post" onsubmit="return false">
			<input name="method" id="method" type="hidden" value="superviseOutNowList"/>
			<input name="superviseImportquery.state" id="superviseImportquery.state" type="hidden" value="2"/>
			...
			<div class="public-main-footer hidden abs">
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="superviseOutNowList" action="/superviseOut.do?method=superviseOutNowList"/>
				</div>
			</div>
		</html:form>
	</div>

...
function doLoad(){
	...
	if(role!=4){
		...
		var array=document.getElementsByName("repository.status");
...
<div class="add_nav">
	<span class="add_nav_acolor">
            ...
            <a class="crumbs-link" style="color:#929291;" href="#">储备库</a>
             &gt;
            <a class="crumbs-link" style="color:#929291;" href="#">新增储备库信息</a>
    </span>
</div>
<br/>
...
<input type="hidden" name="method" id="method" value="addRepository"/>

<table class="formTable">
	<tr class="formTitle">
		<td colspan="4">新增储备库信息 </td>
	</tr>
	<tr>
		<td colspan="4"> 
			<table >

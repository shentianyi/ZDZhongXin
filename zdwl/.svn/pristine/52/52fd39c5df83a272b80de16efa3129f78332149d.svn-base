...
function goOld(){
	location.href="<url:context/>/superviseMove.do?method=superviseMoveList";
}
</script>
</head>
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                <a class="button fl" href="javascript:goOld();">监管物移动</a>
                <a class="button btn-sel fl" href="javascript:void(0);">监管物移动申请中</a>
            </div>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/superviseMove" styleId="superviseImportForm" method="post" onsubmit="return false">
			<input name="method" id="method" type="hidden" value="superviseMoveNowList"/>
			...
			<div class="public-main-footer hidden abs">
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="superviseMoveNowList" action="/superviseMove.do?method=superviseMoveNowList"/>
				</div>
			</div>
		</html:form>
	</div>

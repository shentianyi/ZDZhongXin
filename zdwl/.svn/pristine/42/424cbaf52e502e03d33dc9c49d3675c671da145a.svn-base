...
<div class="public-bar hidden">
	<div class="ly-contai clearfix">
		<div class="public-bar-crumbs fl hidden">
            ...
            > 
            <a class="crumbs-link" href="#">监管费用统计详情</a>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai public-main-input-false rel">
		...
		<input name="method" id="method" type="hidden" value="paymentDetailList" />
					...
					<tbody class="t-tbody hidden">
						<logic:iterate name="list" id="row" indexId="index">
							<tr class="t-tr">
								...
								<td class="t-td"><fmt:formatDate value="${row.actualPaymentDate}" pattern="yyyy-MM-dd"/></td>
		...
		<div class="public-main-footer hidden abs">
			...
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="paymentDetailList" action="/ledger/dealer.do?method=paymentDetailList" />
			</div>
		</div>
		</html:form>
	</div>

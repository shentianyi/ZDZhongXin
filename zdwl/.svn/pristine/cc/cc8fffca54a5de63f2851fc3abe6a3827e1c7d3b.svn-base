...
//执行返回列表操作
function doReturn(){
	location = "<url:context/>/carOperation.do?method=movefindList";
}
</script>
</head>
<body>
	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/carOperation.do" styleId="carOperationForm" method="post" onsubmit="return false">
				<html:hidden property="carOperation.id" styleId="carOperation.id"/>

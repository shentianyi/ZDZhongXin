...
//进入资源下已分配角色页面
function goRoleWithoutResource(){
	location = "<url:context/>/rbac/role.do?method=roleListWithoutResource&resourceId=<c:out value="${resourceId}"/>&<thumbpage:setQueryFlag tableName="roleListWithoutResource" out="true"/>";
}
	...
	<div class="ly-contai clearfix">
        <div class="public-bar-tab fr hidden clearfix">
            <div class="ly-button-w fr">
                ...
                <a class="button fl" href="javascript:goRoleWithoutResource();">分配新角色</a>
            </div>
        </div>
	</div>
</div>
<div class="public-main abs">
	<div class="ly-contai rel">
		<html:form action="/rbac/role" styleId="roleForm" method="post" onsubmit="return false">
			<input type="hidden" name="method" id="method" value="roleListWithResource">
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_TAGBAR.getCode()%>" tableName="roleListWithResource" action="/rbac/role.do?method=roleListWithResource"/>
				</div>
			</div>
		</html:form>
	</div>

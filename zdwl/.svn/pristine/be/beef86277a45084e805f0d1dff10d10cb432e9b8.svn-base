	...
	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/repaircost" styleId="repairCostForm" method="post" onsubmit="return false">
				...
				<input type="hidden" name="repaircostquery.id" value="<c:out value='${repairCostForm.repaircost.id }'/>"/>
				<html:hidden property="repaircostquery.approvalState" styleId="approvalState"/>
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol" colspan="3">
							<html:textarea property="repaircostquery.remark"></html:textarea>
						</td>
					</tr>

		...
		<html:form action="/message/supMaMsg" styleId="messageForm" method="post" onsubmit="return false">
			...
			<div class="ly-input-w">
				<div class="ly-row clearfix">
                    ...
                    <div class="ly-col fl">
                        <div class="label block fl hidden">培训开始时间：</div>
                        <div class="input block fl hidden">
                       		 <form:calendar property="supMaQuery.trainTime" styleId="trainTime" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
                        </div>
                    </div>
                    <div class="ly-col fl">
                        <div class="label block fl hidden">培训结束时间：</div>
                        <div class="input block fl hidden">
                        	<form:calendar property="supMaQuery.trainCheckDate" styleId="trainCheckDate" pattern="<%=PatternConstants.TIMESTAMP.getCode()%>" readonly="true" />
                        </div>
                    </div>
                     <div class="ly-col fl">
					...
					<table class="t-table" border="0" cellspacing="0" cellpadding="0">
						<thead class="t-thead">
							<tr class="t-tr">
								...
								<th class="t-th">培训开始时间</th>
								<th class="t-th">培训结束时间</th>
						...
						<tbody class="t-tbody hidden">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<select:timestamp timestamp="${row.trainTime}" idtype="date"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<select:timestamp timestamp="${row.trainCheckDate}" idtype="date"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>

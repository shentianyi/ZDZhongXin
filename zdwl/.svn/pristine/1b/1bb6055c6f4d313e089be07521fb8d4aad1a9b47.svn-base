...
<script>
	...
	function goAlreadyApproval(){
		location.href="<url:context/>/carOperation.do?method=outfindList&carOperationquery.pageType=2";
	}
	
	function approval(id){
		location.href="<url:context/>/carOperation.do?method=outPreApproval&carOperation.id="+id;
	}
	
	function detail(id){
		location.href="<url:context/>/carOperation.do?method=outDetailPage&carOperation.id="+id;
	}

...
function goAddUser(){
	...
	location = "<url:context/>/rbac/dealerGroup.do?method=addUserEntry&dealerGroup.id="+id;
}
		...
		<html:form action="/rbac/dealerGroup" styleId="dealerGroupForm" method="post" onsubmit="return false">
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_TAGBAR.getCode()%>" tableName="pageList" action="/rbac/dealerGroup.do?method=userEntry"/>
				</div>
			</div>
		</html:form>
	</div>

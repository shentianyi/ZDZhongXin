...
function toDetail(id){
	location.href="/ledger/dealer.do?method=paymentDetailList&query.id="+id;
}
//导出execl
/* function goExt(){
    $("#method").val("ExtexpenseTotalLedger");
    document.forms[0].submit();
} */
</script>
<style type="text/css">
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<input name="method" id="method" type="hidden" value="expenseTotalLedger" />
					...
					<tbody class="t-tbody hidden">
						<logic:iterate name="list" id="row" indexId="index">
							<tr class="t-tr">
								...
								<!-- 新增列 start -->
                                <td class="t-td"><c:out value="${row.province }"/>
                                </td>
		...
		<div class="public-main-footer hidden abs">
		    <!-- <a href="javascript:goExt();" class="button btn-add fl">导出监管费台账</a> -->
			<div class="public-main-footer-pagin fr">
				<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="expenseTotalLedger" action="/ledger/dealer.do?method=expenseTotalLedger" />
			</div>
		</div>
		</html:form>
	</div>

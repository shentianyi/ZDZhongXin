...
function doLoad(){
	...
	function goWaitApproval(){
		location.href="<url:context/>/duedate.do?method=findList";
	}
...
<div class="public-main abs">
	<div class="ly-contai rel">
		...
		<html:form action="/duedate.do" styleId="duedateForm" method="post" onsubmit="return false">
			...
			<input type="hidden" name="duedatequery.pageType" id="duedatequery.pageType" value="2">
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==2 && duedateForm.duedatequery.currRole == supervisory }">

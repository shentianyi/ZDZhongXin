...
function doLoad(){
	...
	function goWaitApproval(){
		location.href="<url:context/>/supervisor/checkStock.do?method=findList";
	}
							...
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										...
										<c:if test="${row.approvalState==2 && checkStockForm.query.currRole == supervisor_commissioner }">

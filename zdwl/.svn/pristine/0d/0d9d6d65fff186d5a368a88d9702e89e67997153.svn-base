package com.zd.csms.supervisory.model.costmail;
 ...
 *
 */
@table(name="T_SUPERVISOR_COSTMAIL")
public class SupervisorCostMailMessageVO implements Serializable {
	 ...
	 * @return the 邮寄项目
	 */
	public String getCostmail() {
		return costmail;
	}
	/**
	 * @param 邮寄项目 the costmail to set
	 */
	public void setCostmail(String costmail) {

					...
					<table class="t-table" border="0" cellspacing="0" cellpadding="0">
						<thead class="t-thead">
							<tr class="t-tr">
								...
								<th class="t-th">上午应签到时间</th>
								<th class="t-th">上午实际签到时间</th>
								<th class="t-th">上午应签退时间</th>
								<th class="t-th">上午实际签退时间</th>
								<th class="t-th">下午应签到时间</th>
								<th class="t-th">下午实际签到时间</th>
								<th class="t-th">下午应签退时间</th>
								<th class="t-th">下午实际签退时间</th>
								<th class="t-th">
						...
						<tbody class="t-tbody hidden">
							<logic:iterate name="list" id="row" indexId="index">
								<tr class="t-tr">
									...
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.shouldMorningStart}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.actualMorningStart}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.shouldMorningEnd}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.actualMorningEnd}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.shouldAfternoonStart}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.actualAfternoonStart}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.shouldAfternoonEnd}"/>
										</font>
									</td>
									<td class="t-td">
										<font <c:if test="${row.isread == 1}">color="red"</c:if>>
											<c:out value="${row.actualAfternoonEnd}"/>
										</font>
									</td>
									<td class="t-td">

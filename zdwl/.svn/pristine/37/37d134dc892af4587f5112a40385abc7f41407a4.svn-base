...
<body onLoad="doLoad()">
	...
	<div class="title">日查库</div>
	<hr size="1">
	<br />

	<div class="pagebodyOuter">
		<div class="pagebodyInner">
			<html:form action="/duedate.do" styleId="duedateForm"
				method="post" onsubmit="return false">
				<input type="hidden" name="method" value="approval" />
				<input type="hidden" name="duedatequery.id" value="<c:out value='${duedateForm.duedate.id }'/>"/>
				<html:hidden property="duedatequery.approvalState" styleId="approvalState"/>
				...
				<table class="formTable">
					...
					<tr>
						...
						<td class="codeCol">
							<a style="color: blue;" href="/showImg.do?method=downLoadFile&filePath=<c:out value='${file1}' />&fileName=<c:out value='${pic1}' />"><c:out value='${pic1}' /></a>
							<%-- <a href="javascript:showDiv('<c:out value='${pic1}' />');">
								<form:img value="${file1}" height="80" width="120"></form:img>
							</a> --%>
						</td>
						<%-- <td class="nameCol">文件2：</td>
						<td class="codeCol">
							<a style="color: blue;" href=<c:out value='${file2}' />><c:out value='${pic2}' /></a>
						</td> --%>
					...
					<%-- <tr>
						<td class="nameCol">文件3：</td>
						<td class="codeCol">
							<a style="color: blue;" href=<c:out value='${file3}' />><c:out value='${pic3}' /></a>
							<a href="javascript:showDiv('<c:out value='${pic3}' />');">
								<form:img value="${file3}" height="80" width="120"></form:img>
							</a>
						</td>
						<td class="nameCol">文件4：</td>
						<td class="codeCol">
							<a style="color: blue;" href=<c:out value='${file4}' />><c:out value='${pic4}' /></a>
					...
					<tr>
						<td class="nameCol">文件5：</td>
						<td class="codeCol">
							<a style="color: blue;" href=<c:out value='${file5}' />><c:out value='${pic5}' /></a>
					...
					<tr>
						...
						<td class="codeCol" colspan="3"><html:text property="duedatequery.remark"></html:text></td>
					</tr>

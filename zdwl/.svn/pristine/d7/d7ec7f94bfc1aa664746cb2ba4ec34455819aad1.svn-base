package com.zd.csms.supervisory.service.outstock;
...
public class SupervisorOutStockMessageService extends ServiceSupport{

	private SupervisorOutStockMessageDao dao = SupervisorDAOFactory.getSupervisorOutStock();
	
	public boolean addOutStockMessage(SupervisorOutStockMessageVO vo) throws Exception {
		vo.setId(Util.getID(SupervisorOutStockMessageVO.class));
	...
	public List<SupervisorOutStockMessageVO> searchOutStockList(SupervisorOutStockMessageQueryVO query){
		return dao.searchOutStockList(query);
	}
	
	public List<SupervisorOutStockMessageVO> searchOutStockListByPage(SupervisorOutStockMessageQueryVO vo, IThumbPageTools tools){
		...
		return dao.searchOutStockListByPage(vo, tools);
	}

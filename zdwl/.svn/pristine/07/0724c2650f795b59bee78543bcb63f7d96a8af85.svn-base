...
function goUser(){
	...
	location = "<url:context/>/rbac/brandGroup.do?method=userEntry&brandGroup.id="+id;
}
		...
		<html:form action="/rbac/brandGroup" styleId="brandGroupForm" method="post" onsubmit="return false">
			...
			<div class="public-main-footer hidden abs">
				...
				<div class="public-main-footer-pagin fr">
					<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_TAGBAR.getCode()%>" tableName="pageList" action="/rbac/brandGroup.do?method=addUserEntry"/>
				</div>
			</div>
		</html:form>
	</div>

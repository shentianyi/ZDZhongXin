...
<body class="h-100 public" onLoad="doLoad()">
	<div class="public-main abs">
		<div class="ly-contai rel">
			<html:form action="/inspectRemind.do" styleId="/inspectRemindForm" method="post" onsubmit="return false">
				...
				<input type="hidden" id="onehiId" value="<c:out value="${inspectRemindForm.query.oneBankId}"/>"/>
				<input type="hidden" id="twohiId" value="<c:out value="${inspectRemindForm.query.twoBankId}"/>"/>
				<input type="hidden" id="threehiId" value="<c:out value="${inspectRemindForm.query.threeBankId}"/>"/>
				...
				<div class="public-main-input ly-col-2 hidden abs" style="height: 165px;margin-top: -50px;">
					<div class="ly-input-w" style="height: 110px;">
						...
						<div class="ly-row clearfix">
							<div class="ly-col fl" style="width:33%;">
								<div class="label block fl hidden">经销店名称：</div>
								<div class="input block fl hidden">
						...
						<table class="t-table" border="0" cellspacing="0" cellpadding="0">
							<thead class="t-thead">
								<tr class="t-tr">
									...
									<th class="t-th">经销店名称</th>
									<th class="t-th">金融机构</th>
									<th class="t-th">品牌</th>
									<th class="t-th">上传日期</th>
							...
							<tbody class="t-tbody">
								<logic:iterate name="list" id="row" indexId="index">
									<tr class="t-tr" <c:if test="${row.isread==1}">style="color:red;"</c:if>>
										...
										<td class="t-td"><fmt:formatDate value="${row.MODIFY_TIME}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
				...
				<div class="public-main-footer hidden abs">
					...
					<div class="public-main-footer-pagin fr">
						<thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" 
  							tableName="list" action="/inspectRemind.do?method=findList" />
					</div>
				</div>
			</html:form>
		</div>

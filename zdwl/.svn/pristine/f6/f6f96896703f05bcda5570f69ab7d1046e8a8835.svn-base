...
<script>
    ...
    function goWaitApproval(){
        location.href="<url:context/>/dataMailcost.do?method=findList";
    }
    ...
    function detail(id){
        location.href="<url:context/>/dataMailcost.do?method=dataMailingFeeListDetail&dataMailcost.id="+id;
    }
    ...
    //导出execl
	function goExt(){
	    $("#method").val("extDataMailingFeeExcel");
...
<div class="add_nav">
		<span class="add_nav_acolor">
            ...
            > 
            <a class="crumbs-link" href="#">资料邮寄费用台账</a>
         </span>
	</div>
...
<div class="public-main abs">
    <div class="ly-contai public-main-input-false rel">
        <html:form action="/dataMailcost" styleId="dataMailcostForm" method="post" onsubmit="return false">
            <input name="method" id="method" type="hidden" value="dataMailingFeeList" />
                            ...
                            <logic:iterate name="list" id="row" indexId="index">
                                <tr class="t-tr">
                                    ...
                                    <td class="t-td">
                                        ...
                                        <!-- 监管员可操作 -->
                                         <c:if test="${row.status==0 && dataMailcostForm.dataMailcostquery.currRole == 10}">
            ...
            <div class="public-main-footer hidden abs">
	            <a href="javascript:goExt();" class="button btn-add fl yc">导出资料邮寄费用台账</a>
	            <div class="public-main-footer-pagin fr">
	                <thumbpage:tools className="<%=ThumbPageConstants.CLASSNAME_DEFAULT.getCode()%>" tableName="dataMailingFeeList" action="/dataMailcost.do?method=dataMailingFeeList" />
	            </div>
	        </div>
        </html:form>
    </div>

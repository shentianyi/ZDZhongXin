...
<div class="title">汇票到期当天提醒</div>
<div class="pagebodyOuter">
	<div class="pagebodyInner">
	
<html:form action="/message/ExpirethedayMessage" styleId="messageForm" method="post" onsubmit="return false">
<input name="method" id="method" type="hidden" value="expiretheday"/>
<div class="dvScroll">

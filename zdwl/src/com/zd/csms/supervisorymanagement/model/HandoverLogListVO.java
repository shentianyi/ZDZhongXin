...
public class HandoverLogListVO implements Serializable {
	 ...
	 * 下一审批人
	 */
	private String nextApprovalStr;
	/**
	...
	public String getNextApprovalStr() {
		return nextApprovalStr;
	}
	public void setNextApprovalStr(String nextApprovalStr) {
		this.nextApprovalStr = nextApprovalStr;
	}
	...
	public int getPicIsEdit() {
		return picIsEdit;
	}
	public void setPicIsEdit(int picIsEdit) {

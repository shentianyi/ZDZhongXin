...
public class RemovePledgeDetailDAO extends DAOSupport implements IRemovePledgeDetailDAO {
	...
	// 资源查询语句
	private static String select_removepledgedetail = "SELECT ID,RDNO,RDCMDCODE,RDCMDNAME,RDUNIT,RDSTKNUM,RDRLSMGNUM,RDWHCODE,RDSCFLONNO,RDCHATTELPDNO,RDNUMBER,RDCHASSISNO,RDCERTIFICATIONNO,RDCARPRICE,RDUSERNAME,RDUSERCARDID FROM ZX_REMOVEPLEDGEDETAIL WHERE 1=1";
	...
	@Override
	public boolean add(RemovePledgeDetail removePledgeDetail) {
		removePledgeDetail.setId(SqlUtil.getID(RemovePledgeDetail.class));
		return super.add(removePledgeDetail);
	}

...
public class AgreementDAO extends DAOSupport implements IAgreementDAO {
	 ...
	 * @param query
	 */
	private void formatSQL(StringBuffer sql, List<Object> params, Agreement query) {
		...
		sql.append(" order by agupdatedate desc nulls last");
	}
	...
	public Agreement getAgreement(String LonentNo) {
		String sql = "SELECT * FROM ZX_AGREEMENT WHERE AGLONCPID='" + LonentNo + "'";
	...
	public List<String> getListNtcno() {
		String sql = "SELECT DISTINCT AGLONCPID FROM ZX_AGREEMENT";
...
//	@Override
//	public String getDataSoutceName() {

...
public class RemovePledgeDetail implements Serializable {
	...
	public String toString() {
		return "RemovePledgeDetail [id=" + id + ", rdNo=" + rdNo + ", rdCmdcode=" + rdCmdcode + ", rdCmdname="
				+ rdCmdname + ", rdUnit=" + rdUnit + ", rdStknum=" + rdStknum + ", rdRlsmgnum=" + rdRlsmgnum
				+ ", rdWhcode=" + rdWhcode + ", rdScflonno=" + rdScflonno + ", rdChattelpdno=" + rdChattelpdno
				+ ", rdNumber=" + rdNumber + ", rdChassisno=" + rdChassisno + ", rdCertificationno="
				+ rdCertificationno + ", rdCarprice=" + rdCarprice + ", rdUsername=" + rdUsername + ", rdUsercardid="
				+ rdUsercardid + "]";
	}

...
public class Warehouse {
	...
	public String toString() {
		return "Warehouse [whid=" + whid + ", custNo=" + custNo + ", whlonentnm=" + whlonentnm + ", whName=" + whName
				+ ", whCode=" + whCode + ", whLevel=" + whLevel + ", whOperorg=" + whOperorg + ", whAddress="
				+ whAddress + ", phone=" + phone + ", lonentid=" + lonentid + ", whdistance=" + whdistance
				+ ", whContacts=" + whContacts + ", createDate=" + createDate + ", updateDate=" + updateDate + "]";
	}

...
public class Checkwarehouse {
	...
	private int chCsid;//--外键引用盘库表主键   //暂无用
	...
	public String toString() {
		return "Checkwarehouse [chId=" + chId + ", chCsid=" + chCsid + ", chWhlevel=" + chWhlevel + ", chWhcode="
				+ chWhcode + ", chWhname=" + chWhname + ", chWhaddr=" + chWhaddr + ", chNum=" + chNum + "]";
	}

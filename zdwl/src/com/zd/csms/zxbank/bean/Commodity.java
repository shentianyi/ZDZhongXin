...
public class Commodity implements Serializable {
	...
	public String toString() {
		return "Commodity [cmId=" + cmId + ", cmGaid=" + cmGaid + ", cmCmdcode=" + cmCmdcode + ", cmStknum=" + cmStknum
				+ ", cmIstkprc=" + cmIstkprc + ", cmVin=" + cmVin + ", cmHgzno=" + cmHgzno + ", cmCarprice="
				+ cmCarprice + ", cmLoancode=" + cmLoancode + "]";
	}
}

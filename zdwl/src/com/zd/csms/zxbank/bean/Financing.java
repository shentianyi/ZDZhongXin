...
public class Financing {
	...
	public String toString() {
		return "Financing [fiId=" + fiId + ", fgLonentNo=" + fgLonentNo + ", fgLoncpName=" + fgLoncpName
				+ ", fgStDate=" + fgStDate + ", fgEndDate=" + fgEndDate + ", fgLoanCode=" + fgLoanCode + ", fgScftxNo="
				+ fgScftxNo + ", fgLoanAmt=" + fgLoanAmt + ", fgBailRat=" + fgBailRat + ", fgSlfcap=" + fgSlfcap
				+ ", fgFstblRat=" + fgFstblRat + ", fgProcrt=" + fgProcrt + ", fgBizMod=" + fgBizMod + ", fgOperOrg="
				+ fgOperOrg + ", fgagtid=" + fgagtid + ", fgCreateDate=" + fgCreateDate + ", fgUpdateDate="
				+ fgUpdateDate + "]";
	}

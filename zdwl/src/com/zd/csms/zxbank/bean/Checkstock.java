...
public class Checkstock {
	...
	private String csLoncpname;//--借款企业名称
	...
	private Date csCreatedate;// --创建时间
	...
	public String getCsLoncpname() {
		return csLoncpname;
	}

	public void setCsLoncpname(String csLoncpname) {
		this.csLoncpname = csLoncpname;
	}

	@Override
	public String toString() {
		return "Checkstock [csId=" + csId + ", csLoncpid=" + csLoncpid
				+ ", csLoncpname=" + csLoncpname + ", csProtocolno="

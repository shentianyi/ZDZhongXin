...
public class ReceivingNotice implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6734593424492455259L;
	private int id;//--收货通知表主键id
	...
	public String toString() {
		return "ReceivingNotice [id=" + id + ", nyNo=" + nyNo + ", nyCorentnm=" + nyCorentnm + ", nySpventnm="
				+ nySpventnm + ", nyOnwspvenm=" + nyOnwspvenm + ", nyTrsptentnm=" + nyTrsptentnm + ", nyLonentno="
				+ nyLonentno + ", nyLonentname=" + nyLonentname + ", nyCsndate=" + nyCsndate + ", nyEta=" + nyEta
				+ ", nyEpa=" + nyEpa + ", nyOfflnsatno=" + nyOfflnsatno + ", nyNtcdate=" + nyNtcdate + ", nyTtlcmdval="
				+ nyTtlcmdval + ", nyExcplace=" + nyExcplace + ", nyRemark=" + nyRemark + ", nyTotnum=" + nyTotnum
				+ ", nyCreatedate=" + nyCreatedate + ", nyUpdatedate=" + nyUpdatedate + "]";
	}

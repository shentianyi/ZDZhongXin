...
public class RemovePledge implements Serializable {
	...
	public String toString() {
		return "RemovePledge [id=" + id + ", rpNo=" + rpNo + ", rpOperorg=" + rpOperorg + ", rpPldegeename="
				+ rpPldegeename + ", rpLoncpid=" + rpLoncpid + ", rpLoncpname=" + rpLoncpname + ", rpSupervisename="
				+ rpSupervisename + ", rpCorename=" + rpCorename + ", rpRelievepddate=" + rpRelievepddate
				+ ", rpContent=" + rpContent + ", rpNoticedate=" + rpNoticedate + ", rpCreatedate=" + rpCreatedate
				+ ", rpUpdatedate=" + rpUpdatedate + "]";
	}

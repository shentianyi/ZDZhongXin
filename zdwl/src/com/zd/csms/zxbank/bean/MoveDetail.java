...
public class MoveDetail implements Serializable {
	...
	public String toString() {
		return "MoveDetail [id=" + id + ", mdNo=" + mdNo + ", mdRemoveoutno=" + mdRemoveoutno + ", mdRemoveinno="
				+ mdRemoveinno + ", mdWareno=" + mdWareno + ", mdMovenumber=" + mdMovenumber + ", mdChassisno="
				+ mdChassisno + ", mdCertificationno=" + mdCertificationno + ", mdCarprice=" + mdCarprice + "]";
	}

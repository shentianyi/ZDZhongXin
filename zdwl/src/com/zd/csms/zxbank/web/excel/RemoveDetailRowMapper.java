...
public class RemoveDetailRowMapper implements IImportRowMapper{
	...
	public String[] exportRow(Object obj) {
		...
		return new String[]{rd.getRdCmdcode(),rd.getRdCmdname(),rd.getRdUnit(),rd.getRdStknum()+"",rd.getRdRlsmgnum()+"",rd.getRdWhcode(),rd.getRdScflonno(),rd.getRdChattelpdno(),rd.getRdUsername(),rd.getRdUsercardid(),rd.getRdNumber()==null?"":rd.getRdNumber().toString(),rd.getRdChassisno(),rd.getRdCertificationno(),rd.getRdCarprice()==null?"":rd.getRdCarprice().toString()};
	}

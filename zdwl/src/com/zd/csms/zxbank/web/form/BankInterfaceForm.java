...
public class BankInterfaceForm extends ActionForm {
	 ...
	 * 通知详情Form
	 */
	private PushNoticeDetail pushnoticedetail =new PushNoticeDetail();
	...
	public PushNoticeDetail getPushnoticedetail() {
		return pushnoticedetail;
	}

	public void setPushnoticedetail(PushNoticeDetail pushnoticedetail) {
		this.pushnoticedetail = pushnoticedetail;
	}

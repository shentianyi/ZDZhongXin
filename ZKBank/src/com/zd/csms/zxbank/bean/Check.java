...
public class Check {
	...
	private int ckCstkcmdnum;//--盘库商品数量
	private String ckCmgrtcntno;//--动产质押担保合同编号
	...
	public int getCkCstkcmdnum() {
		return ckCstkcmdnum;
	}
	public void setCkCstkcmdnum(int ckCstkcmdnum) {
		this.ckCstkcmdnum = ckCstkcmdnum;
	}
	public String getCkCmgrtcntno() {
		return ckCmgrtcntno;
	}
	public void setCkCmgrtcntno(String ckCmgrtcntno) {
		this.ckCmgrtcntno = ckCmgrtcntno;
	}
	...
	public String toString() {
		return "Check [ckId=" + ckId + ", ckCsid=" + ckCsid + ", ckSpvwhcode="
				+ ckSpvwhcode + ", ckCmcode=" + ckCmcode + ", ckCstkcmdnum="
				+ ckCstkcmdnum + ", ckCmgrtcntno=" + ckCmgrtcntno + ", ckVin="
				+ ckVin + "]";
	}
}

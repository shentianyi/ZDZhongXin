 ...
 * 翻页工具翻页工具条及翻页信息输出标签
 */
public class ThumbPageToolsTag2 extends TagSupport {

	private static final long serialVersionUID = 468970603791882408L;

	private String tableName;													//翻页表格名称
	private String toolsType = ThumbPageConstants.TOOLSTYPE_HEAD.getCode();		//工具栏类型－表头、表?
	...
	public int doStartTag() throws JspException {
		...
		if(toolsType.equals(ThumbPageConstants.TOOLSTYPE_HEAD.getCode())){
			...
			try{
				...
				pageContext.getOut().write(tools.getHeadToolsHTML2());
